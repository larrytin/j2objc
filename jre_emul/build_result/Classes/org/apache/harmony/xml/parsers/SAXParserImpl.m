...
- (void)resetInternal {
  @try {
    ...
    {
      id<JavaUtilIterator> iter__ = [((id<JavaUtilSet>) nil_chk([((id<JavaUtilMap>) nil_chk(initialFeatures_)) entrySet])) iterator];
      while ([((id<JavaUtilIterator>) nil_chk(iter__)) hasNext]) {
        id<JavaUtilMap_Entry> entry = [iter__ next];
        [reader_ setFeatureWithNSString:[((id<JavaUtilMap_Entry>) nil_chk(entry)) getKey] withBOOL:[((JavaLangBoolean *) nil_chk([entry getValue])) booleanValue]];
      }
    }
  }

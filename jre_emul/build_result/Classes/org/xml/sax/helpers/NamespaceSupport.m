...
- (IOSObjectArray *)processNameWithNSString:(NSString *)qName
  ...
  if (index == -1) {
    if (isAttribute) {
      if (((!qName && !@"xmlns") || [qName isEqualToString:@"xmlns"]) && this$0_.namespaceDeclUris) [((IOSObjectArray *) NIL_CHK(name)) replaceObjectAtIndex:0 withObject:[OrgXmlSaxHelpersNamespaceSupport NSDECL]];

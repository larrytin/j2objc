...
+ (NSString *)getDisplayNameWithNSStringArray2:(IOSObjectArray *)zoneStrings
  ...
  if (index >= 0) {
    ...
    if (daylight) {
      return (style == JavaUtilTimeZone_LONG) ? IOSObjectArray_Get(nil_chk(row), LibcoreIcuTimeZones_LONG_NAME_DST) : IOSObjectArray_Get(nil_chk(row), LibcoreIcuTimeZones_SHORT_NAME_DST);
    }
    else {
      return (style == JavaUtilTimeZone_LONG) ? IOSObjectArray_Get(nil_chk(row), LibcoreIcuTimeZones_LONG_NAME) : IOSObjectArray_Get(nil_chk(row), LibcoreIcuTimeZones_SHORT_NAME);
    }
  }
  return nil;
}
...
- (int)compareWithId:(IOSObjectArray *)lhs
  ...
  return [((NSString *) nil_chk(IOSObjectArray_Get(nil_chk(lhs), LibcoreIcuTimeZones_OLSON_NAME))) compareToWithId:IOSObjectArray_Get(nil_chk(rhs), LibcoreIcuTimeZones_OLSON_NAME)];
}

...
//  source: /Users/retechretech/dev/tools/lib/j2objc/jre_emul/apache_harmony/classlib/modules/luni/src/main/java/java/io/FileInputStream.java
//
...
- (id)repositioningLock {
  return [[repositioningLock_ retain] autorelease];
}

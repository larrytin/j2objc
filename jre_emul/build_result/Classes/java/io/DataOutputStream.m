...
+ (IOSObjectArray *)__exceptions_writeBooleanWithBoolean_ {
  return [IOSObjectArray arrayWithObjects:(id[]) { [JavaIoIOException getClass] } count:1 type:[IOSClass getClass]];
}
...
- (void)writeBytesWithNSString:(NSString *)str {
  ...
  for (int index = 0; index < [str length]; index++) {
    (*IOSByteArray_GetRef(bytes, index)) = (char) [str charAtWithInt:index];
  }
...
- (void)writeCharWithInt:(int)val {
  (*IOSByteArray_GetRef(nil_chk(buff_), 0)) = (char) (val >> 8);
  (*IOSByteArray_GetRef(buff_, 1)) = (char) val;
...
- (void)writeCharsWithNSString:(NSString *)str {
  ...
  for (int index = 0; index < [str length]; index++) {
    ...
    (*IOSByteArray_GetRef(newBytes, newIndex)) = (char) ([str charAtWithInt:index] >> 8);
    (*IOSByteArray_GetRef(newBytes, newIndex + 1)) = (char) [str charAtWithInt:index];
  }
...
- (void)writeDoubleWithDouble:(double)val {
  [self writeLongWithLong:[JavaLangDouble doubleToLongBitsWithDouble:val]];
}
...
- (void)writeIntWithInt:(int)val {
  (*IOSByteArray_GetRef(nil_chk(buff_), 0)) = (char) (val >> 24);
  (*IOSByteArray_GetRef(buff_, 1)) = (char) (val >> 16);
  (*IOSByteArray_GetRef(buff_, 2)) = (char) (val >> 8);
  (*IOSByteArray_GetRef(buff_, 3)) = (char) val;
...
- (void)writeLongWithLong:(long long int)val {
  (*IOSByteArray_GetRef(nil_chk(buff_), 0)) = (char) (val >> 56);
  (*IOSByteArray_GetRef(buff_, 1)) = (char) (val >> 48);
  (*IOSByteArray_GetRef(buff_, 2)) = (char) (val >> 40);
  (*IOSByteArray_GetRef(buff_, 3)) = (char) (val >> 32);
  (*IOSByteArray_GetRef(buff_, 4)) = (char) (val >> 24);
  (*IOSByteArray_GetRef(buff_, 5)) = (char) (val >> 16);
  (*IOSByteArray_GetRef(buff_, 6)) = (char) (val >> 8);
  (*IOSByteArray_GetRef(buff_, 7)) = (char) val;
  [((JavaIoOutputStream *) nil_chk(out_)) writeWithByteArray:buff_ withInt:0 withInt:8];
  written_ += 8;
}

+ (IOSObjectArray *)__exceptions_writeLongWithLong_ {
  return [IOSObjectArray arrayWithObjects:(id[]) { [JavaIoIOException getClass] } count:1 type:[IOSClass getClass]];
}
...
- (int)writeLongToBufferWithLong:(long long int)val
                   withByteArray:(IOSByteArray *)buffer
                         withInt:(int)offset {
  (*IOSByteArray_GetRef(nil_chk(buffer), offset++)) = (char) (val >> 56);
  (*IOSByteArray_GetRef(buffer, offset++)) = (char) (val >> 48);
  (*IOSByteArray_GetRef(buffer, offset++)) = (char) (val >> 40);
  (*IOSByteArray_GetRef(buffer, offset++)) = (char) (val >> 32);
  (*IOSByteArray_GetRef(buffer, offset++)) = (char) (val >> 24);
  (*IOSByteArray_GetRef(buffer, offset++)) = (char) (val >> 16);
  (*IOSByteArray_GetRef(buffer, offset++)) = (char) (val >> 8);
  (*IOSByteArray_GetRef(buffer, offset++)) = (char) val;
  return offset;
}

+ (IOSObjectArray *)__exceptions_writeLongToBufferWithLong_withByteArray_withInt_ {
  return [IOSObjectArray arrayWithObjects:(id[]) { [JavaIoIOException getClass] } count:1 type:[IOSClass getClass]];
}
...
- (int)writeShortToBufferWithInt:(int)val
                   withByteArray:(IOSByteArray *)buffer
                         withInt:(int)offset {
  (*IOSByteArray_GetRef(nil_chk(buffer), offset++)) = (char) (val >> 8);
  (*IOSByteArray_GetRef(buffer, offset++)) = (char) val;
  return offset;
}
...
- (void)writeUTFWithNSString:(NSString *)str {
  ...
  offset = [self writeUTFBytesToBufferWithNSString:str withLong:(int) utfCount withByteArray:buffer withInt:offset];
...
- (int)writeUTFBytesToBufferWithNSString:(NSString *)str
  ...
  for (int i = 0; i < length; i++) {
    int charValue = [str charAtWithInt:i];
    if (charValue > 0 && charValue <= 127) {
      (*IOSByteArray_GetRef(nil_chk(buffer), offset++)) = (char) charValue;
    }
    else if (charValue <= 2047) {
      (*IOSByteArray_GetRef(nil_chk(buffer), offset++)) = (char) ((int) 0xc0 | ((int) 0x1f & (charValue >> 6)));
      (*IOSByteArray_GetRef(buffer, offset++)) = (char) ((int) 0x80 | ((int) 0x3f & charValue));
    }
    else {
      (*IOSByteArray_GetRef(nil_chk(buffer), offset++)) = (char) ((int) 0xe0 | ((int) 0x0f & (charValue >> 12)));
      (*IOSByteArray_GetRef(buffer, offset++)) = (char) ((int) 0x80 | ((int) 0x3f & (charValue >> 6)));
      (*IOSByteArray_GetRef(buffer, offset++)) = (char) ((int) 0x80 | ((int) 0x3f & charValue));
    }
  }
  return offset;
...
+ (IOSObjectArray *)__exceptions_writeUTFBytesToBufferWithNSString_withLong_withByteArray_withInt_ {
  return [IOSObjectArray arrayWithObjects:(id[]) { [JavaIoIOException getClass] } count:1 type:[IOSClass getClass]];
}

...
- (BOOL)isEqual:(id)other {
  ...
  JavaNioShortBuffer *otherBuffer = (JavaNioShortBuffer *) check_class_cast(other, [JavaNioShortBuffer class]);
...
- (JavaNioShortBuffer *)putWithShort:(short int)s {
  // can't call an abstract method
  [self doesNotRecognizeSelector:_cmd];
  return 0;
}
...
- (JavaNioShortBuffer *)putWithShortArray:(IOSShortArray *)src
  ...
  for (int i = off; i < off + len; i++) {
    [self putWithShort:IOSShortArray_Get(src, i)];
  }
  return self;
}

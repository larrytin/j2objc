...
//  source: /Users/retechretech/dev/tools/lib/j2objc/jre_emul/apache_harmony/classlib/modules/nio/src/main/java/common/java/nio/CharSequenceAdapter.java
//
...
- (id<JavaLangCharSequence>)sequence {
  return [[sequence_ retain] autorelease];
}
...
- (JavaNioCharBuffer *)getWithJavaLangCharacterArray:(IOSCharArray *)dest
  ...
  [[((id<JavaLangCharSequence>) NIL_CHK(sequence_)) description] getChars:position__ sourceEnd:newPosition destination:dest destinationBegin:off];

...
- (JavaNioByteBuffer *)putWithByte:(char)b {
  ...
  (*IOSByteArray_GetRef(nil_chk(backingArray_), offset_ + position__++)) = b;
  return self;
}
...
- (JavaNioByteBuffer *)putWithInt:(int)index
  ...
  (*IOSByteArray_GetRef(nil_chk(backingArray_), offset_ + index)) = b;
  return self;
}
...
- (JavaNioByteBuffer *)putDoubleWithDouble:(double)value {
  return [self putLongWithLong:[JavaLangDouble doubleToRawLongBitsWithDouble:value]];
}

- (JavaNioByteBuffer *)putDoubleWithInt:(int)index
                             withDouble:(double)value {
  return [self putLongWithInt:index withLong:[JavaLangDouble doubleToRawLongBitsWithDouble:value]];
}
...
- (JavaNioByteBuffer *)putLongWithInt:(int)index
  ...
  [self storeWithInt:index withLong:value];
  return self;
}
...
- (JavaNioByteBuffer *)putLongWithLong:(long long int)value {
  ...
  [self storeWithInt:position__ withLong:value];
  position__ = newPosition;
  return self;
}
...
- (JavaNioByteBuffer *)putShortWithInt:(int)index
  ...
  [self storeWithInt:index withShort:value];
  return self;
}
...
- (JavaNioByteBuffer *)putShortWithShort:(short int)value {
  ...
  [self storeWithInt:position__ withShort:value];
  position__ = newPosition;
  return self;
}

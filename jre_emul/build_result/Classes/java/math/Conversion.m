...
//  source: /Users/retechretech/dev/tools/lib/j2objc/jre_emul/apache_harmony/classlib/modules/math/src/main/java/java/math/Conversion.java
//
...
+ (NSString *)toDecimalScaledStringWithJavaMathBigInteger:(JavaMathBigInteger *)val
  ...
  if (sign == 0) {
    switch (scale_) {
      ...
      return @"0.000000";
      default: {
        JavaLangStringBuilder *result1 = [[[JavaLangStringBuilder alloc] init] autorelease];
        if (scale_ < 0) {

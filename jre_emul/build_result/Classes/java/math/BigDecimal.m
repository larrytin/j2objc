...
- (id)initJavaMathBigDecimalWithLongInt:(long long int)smallValue
  ...
  if ((self = [super init])) {
    ...
    self->scale__ = scale_;
    self->bitLength__ = [JavaMathBigDecimal bitLengthWithLongInt:smallValue];
    JreMemDebugAdd(self);
  }
  return self;
}
...
- (id)initJavaMathBigDecimalWithCharArray:(IOSCharArray *)inArg
  ...
  if ((self = [super init])) {
    ...
    int bufLength = 0;
    if ((offset <= last) && ([inArg charAtIndex:offset] == '+')) {
      offset++;
      begin++;
    }
    int counter = 0;
    BOOL wasNonZero = NO;
    for (; (offset <= last) && ([inArg charAtIndex:offset] != '.') && ([inArg charAtIndex:offset] != 'e') && ([inArg charAtIndex:offset] != 'E'); offset++) {
      if (!wasNonZero) {
        if ([inArg charAtIndex:offset] == '0') {
          counter++;
        }
        else {
          wasNonZero = YES;
    ...
    if ((offset <= last) && ([inArg charAtIndex:offset] == '.')) {
      offset++;
      begin = offset;
      for (; (offset <= last) && ([inArg charAtIndex:offset] != 'e') && ([inArg charAtIndex:offset] != 'E'); offset++) {
        if (!wasNonZero) {
          if ([inArg charAtIndex:offset] == '0') {
            counter++;
          }
    ...
    if ((offset <= last) && (([inArg charAtIndex:offset] == 'e') || ([inArg charAtIndex:offset] == 'E'))) {
      offset++;
      begin = offset;
      if ((offset <= last) && ([inArg charAtIndex:offset] == '+')) {
        offset++;
  ...
  if ((self = [super init])) {
    ...
    if (scale__ < 0) {
      ...
      if (bitLength__ < 64) {
        ...
        JavaMathBigDecimal_set_intVal_(self, [((JavaMathBigInteger *) nil_chk([JavaMathBigInteger valueOfWithLongInt:mantisa])) shiftLeftWithInt:-scale__]);
      }
      scale__ = 0;
    }
    else if (scale__ > 0) {
      if (scale__ < (int) [((IOSLongArray *) nil_chk(JavaMathBigDecimal_LONG_FIVE_POW_)) count] && mantisaBits + [((IOSIntArray *) nil_chk(JavaMathBigDecimal_LONG_FIVE_POW_BIT_LENGTH_)) intAtIndex:scale__] < 64) {
        smallValue_ = mantisa * [JavaMathBigDecimal_LONG_FIVE_POW_ longAtIndex:scale__];
        bitLength__ = [JavaMathBigDecimal bitLengthWithLongInt:smallValue_];
      }
      else {
...
+ (JavaMathBigDecimal *)valueOfWithLongInt:(long long int)unscaledVal
  ...
  if ((unscaledVal == 0) && (scale_ >= 0) && (scale_ < (int) [((IOSObjectArray *) nil_chk(JavaMathBigDecimal_ZERO_SCALED_BY_)) count])) {
    return [JavaMathBigDecimal_ZERO_SCALED_BY_ objectAtIndex:scale_];
  }
...
+ (JavaMathBigDecimal *)valueOfWithLongInt:(long long int)unscaledVal {
  if ((unscaledVal >= 0) && (unscaledVal < JavaMathBigDecimal_BI_SCALED_BY_ZERO_LENGTH)) {
    return [((IOSObjectArray *) nil_chk(JavaMathBigDecimal_BI_SCALED_BY_ZERO_)) objectAtIndex:(int) unscaledVal];
  }
...
- (JavaMathBigDecimal *)addWithJavaMathBigDecimal:(JavaMathBigDecimal *)augend {
  ...
  if (diffScale == 0) {
    if ([JavaLangMath maxWithInt:self->bitLength__ withInt:augend->bitLength__] + 1 < 64) {
      return [JavaMathBigDecimal valueOfWithLongInt:self->smallValue_ + augend->smallValue_ withInt:self->scale__];
    }
...
+ (JavaMathBigDecimal *)addAndMult10WithJavaMathBigDecimal:(JavaMathBigDecimal *)thisValue
  ...
  if (diffScale < (int) [((IOSLongArray *) nil_chk(JavaMathBigDecimal_LONG_TEN_POW_)) count] && [JavaLangMath maxWithInt:((JavaMathBigDecimal *) nil_chk(thisValue))->bitLength__ withInt:((JavaMathBigDecimal *) nil_chk(augend))->bitLength__ + [((IOSIntArray *) nil_chk(JavaMathBigDecimal_LONG_TEN_POW_BIT_LENGTH_)) intAtIndex:diffScale]] + 1 < 64) {
    return [JavaMathBigDecimal valueOfWithLongInt:thisValue->smallValue_ + augend->smallValue_ * [JavaMathBigDecimal_LONG_TEN_POW_ longAtIndex:diffScale] withInt:thisValue->scale__];
  }
  return [[[JavaMathBigDecimal alloc] initWithJavaMathBigInteger:[((JavaMathBigInteger *) nil_chk([((JavaMathBigDecimal *) nil_chk(thisValue)) getUnscaledValue])) addWithJavaMathBigInteger:[JavaMathMultiplication multiplyByTenPowWithJavaMathBigInteger:[((JavaMathBigDecimal *) nil_chk(augend)) getUnscaledValue] withLongInt:diffScale]] withInt:thisValue->scale__] autorelease];
}
...
- (JavaMathBigDecimal *)addWithJavaMathBigDecimal:(JavaMathBigDecimal *)augend
  ...
  if (largerSignum == [((JavaMathBigDecimal *) nil_chk(smaller)) signum]) {
    tempBI = [((JavaMathBigInteger *) nil_chk([JavaMathMultiplication multiplyByPositiveIntWithJavaMathBigInteger:[larger getUnscaledValue] withInt:10])) addWithJavaMathBigInteger:[JavaMathBigInteger valueOfWithLongInt:largerSignum]];
  }
  else {
    tempBI = [((JavaMathBigInteger *) nil_chk([larger getUnscaledValue])) subtractWithJavaMathBigInteger:[JavaMathBigInteger valueOfWithLongInt:largerSignum]];
    tempBI = [((JavaMathBigInteger *) nil_chk([JavaMathMultiplication multiplyByPositiveIntWithJavaMathBigInteger:tempBI withInt:10])) addWithJavaMathBigInteger:[JavaMathBigInteger valueOfWithLongInt:largerSignum * 9]];
  }
...
- (JavaMathBigDecimal *)subtractWithJavaMathBigDecimal:(JavaMathBigDecimal *)subtrahend {
  ...
  if (diffScale == 0) {
    if ([JavaLangMath maxWithInt:self->bitLength__ withInt:subtrahend->bitLength__] + 1 < 64) {
      return [JavaMathBigDecimal valueOfWithLongInt:self->smallValue_ - subtrahend->smallValue_ withInt:self->scale__];
    }
    ...
    if (diffScale < (int) [((IOSLongArray *) nil_chk(JavaMathBigDecimal_LONG_TEN_POW_)) count] && [JavaLangMath maxWithInt:self->bitLength__ withInt:subtrahend->bitLength__ + [((IOSIntArray *) nil_chk(JavaMathBigDecimal_LONG_TEN_POW_BIT_LENGTH_)) intAtIndex:diffScale]] + 1 < 64) {
      return [JavaMathBigDecimal valueOfWithLongInt:self->smallValue_ - subtrahend->smallValue_ * [JavaMathBigDecimal_LONG_TEN_POW_ longAtIndex:diffScale] withInt:self->scale__];
    }
    return [[[JavaMathBigDecimal alloc] initWithJavaMathBigInteger:[((JavaMathBigInteger *) nil_chk([self getUnscaledValue])) subtractWithJavaMathBigInteger:[JavaMathMultiplication multiplyByTenPowWithJavaMathBigInteger:[subtrahend getUnscaledValue] withLongInt:diffScale]] withInt:self->scale__] autorelease];
  }
  else {
    diffScale = -diffScale;
    if (diffScale < (int) [((IOSLongArray *) nil_chk(JavaMathBigDecimal_LONG_TEN_POW_)) count] && [JavaLangMath maxWithInt:self->bitLength__ + [((IOSIntArray *) nil_chk(JavaMathBigDecimal_LONG_TEN_POW_BIT_LENGTH_)) intAtIndex:diffScale] withInt:subtrahend->bitLength__] + 1 < 64) {
      return [JavaMathBigDecimal valueOfWithLongInt:self->smallValue_ * [JavaMathBigDecimal_LONG_TEN_POW_ longAtIndex:diffScale] - subtrahend->smallValue_ withInt:subtrahend->scale__];
    }
    return [[[JavaMathBigDecimal alloc] initWithJavaMathBigInteger:[((JavaMathBigInteger *) nil_chk([JavaMathMultiplication multiplyByTenPowWithJavaMathBigInteger:[self getUnscaledValue] withLongInt:diffScale])) subtractWithJavaMathBigInteger:[subtrahend getUnscaledValue]] withInt:subtrahend->scale__] autorelease];
  }
}
  ...
  if ([subtrahend aproxPrecision] < diffScale - 1) {
    if ([((JavaMathMathContext *) nil_chk(mc)) getPrecision] < [self aproxPrecision]) {
      ...
      if (thisSignum != [subtrahend signum]) {
        tempBI = [((JavaMathBigInteger *) nil_chk([JavaMathMultiplication multiplyByPositiveIntWithJavaMathBigInteger:[self getUnscaledValue] withInt:10])) addWithJavaMathBigInteger:[JavaMathBigInteger valueOfWithLongInt:thisSignum]];
      }
      else {
        tempBI = [((JavaMathBigInteger *) nil_chk([self getUnscaledValue])) subtractWithJavaMathBigInteger:[JavaMathBigInteger valueOfWithLongInt:thisSignum]];
        tempBI = [((JavaMathBigInteger *) nil_chk([JavaMathMultiplication multiplyByPositiveIntWithJavaMathBigInteger:tempBI withInt:10])) addWithJavaMathBigInteger:[JavaMathBigInteger valueOfWithLongInt:thisSignum * 9]];
      }
...
- (JavaMathBigDecimal *)multiplyWithJavaMathBigDecimal:(JavaMathBigDecimal *)multiplicand {
  ...
  if (self->bitLength__ + multiplicand->bitLength__ < 64) {
    return [JavaMathBigDecimal valueOfWithLongInt:self->smallValue_ * multiplicand->smallValue_ withInt:[JavaMathBigDecimal toIntScaleWithLongInt:newScale]];
  }
  return [[[JavaMathBigDecimal alloc] initWithJavaMathBigInteger:[((JavaMathBigInteger *) nil_chk([self getUnscaledValue])) multiplyWithJavaMathBigInteger:[multiplicand getUnscaledValue]] withInt:[JavaMathBigDecimal toIntScaleWithLongInt:newScale]] autorelease];
}
...
- (JavaMathBigDecimal *)divideWithJavaMathBigDecimal:(JavaMathBigDecimal *)divisor
  ...
  if (self->bitLength__ < 64 && divisor->bitLength__ < 64) {
    if (diffScale == 0) {
      return [JavaMathBigDecimal dividePrimitiveLongsWithLongInt:self->smallValue_ withLongInt:divisor->smallValue_ withInt:scale_ withJavaMathRoundingModeEnum:roundingMode];
    }
    else if (diffScale > 0) {
      if (diffScale < (int) [((IOSLongArray *) nil_chk(JavaMathBigDecimal_LONG_TEN_POW_)) count] && divisor->bitLength__ + [((IOSIntArray *) nil_chk(JavaMathBigDecimal_LONG_TEN_POW_BIT_LENGTH_)) intAtIndex:(int) diffScale] < 64) {
        return [JavaMathBigDecimal dividePrimitiveLongsWithLongInt:self->smallValue_ withLongInt:divisor->smallValue_ * [JavaMathBigDecimal_LONG_TEN_POW_ longAtIndex:(int) diffScale] withInt:scale_ withJavaMathRoundingModeEnum:roundingMode];
      }
    }
    else {
      if (-diffScale < (int) [((IOSLongArray *) nil_chk(JavaMathBigDecimal_LONG_TEN_POW_)) count] && self->bitLength__ + [((IOSIntArray *) nil_chk(JavaMathBigDecimal_LONG_TEN_POW_BIT_LENGTH_)) intAtIndex:(int) -diffScale] < 64) {
        return [JavaMathBigDecimal dividePrimitiveLongsWithLongInt:self->smallValue_ * [JavaMathBigDecimal_LONG_TEN_POW_ longAtIndex:(int) -diffScale] withLongInt:divisor->smallValue_ withInt:scale_ withJavaMathRoundingModeEnum:roundingMode];
      }
    }
  }
...
+ (JavaMathBigDecimal *)divideBigIntegersWithJavaMathBigInteger:(JavaMathBigInteger *)scaledDividend
  ...
  JavaMathBigInteger *quotient = [((IOSObjectArray *) nil_chk(quotAndRem)) objectAtIndex:0];
  JavaMathBigInteger *remainder = [quotAndRem objectAtIndex:1];
  ...
  if ([scaledDivisor bitLength] < 63) {
    long long int rem = [remainder longValue];
    long long int divisor = [scaledDivisor longValue];
  ...
  if (compRem != 0) {
    if ([((JavaMathBigInteger *) nil_chk(quotient)) bitLength] < 63) {
      return [JavaMathBigDecimal valueOfWithLongInt:[quotient longValue] + compRem withInt:scale_];
    }
    quotient = [quotient addWithJavaMathBigInteger:[JavaMathBigInteger valueOfWithLongInt:compRem]];
    return [[[JavaMathBigDecimal alloc] initWithJavaMathBigInteger:quotient withInt:scale_] autorelease];
  }
  return [[[JavaMathBigDecimal alloc] initWithJavaMathBigInteger:quotient withInt:scale_] autorelease];
}
...
- (JavaMathBigDecimal *)divideWithJavaMathBigDecimal:(JavaMathBigDecimal *)divisor {
  ...
  do {
    quotAndRem = [((JavaMathBigInteger *) nil_chk(q)) divideAndRemainderWithJavaMathBigInteger:[JavaMathBigDecimal_FIVE_POW_ objectAtIndex:i]];
    if ([((JavaMathBigInteger *) nil_chk([((IOSObjectArray *) nil_chk(quotAndRem)) objectAtIndex:1])) signum] == 0) {
      l += i;
      if (i < lastPow) {
        i++;
      }
      q = [quotAndRem objectAtIndex:0];
    }
    else {
      if (i == 1) {
        break;
...
- (JavaMathBigDecimal *)divideWithJavaMathBigDecimal:(JavaMathBigDecimal *)divisor
  ...
  if (traillingZeros > 0) {
    [quotAndRem replaceObjectAtIndex:0 withObject:[((JavaMathBigInteger *) nil_chk([self getUnscaledValue])) multiplyWithJavaMathBigInteger:[JavaMathMultiplication powerOf10WithLongInt:traillingZeros]]];
    newScale += traillingZeros;
  }
  quotAndRem = [((JavaMathBigInteger *) nil_chk([quotAndRem objectAtIndex:0])) divideAndRemainderWithJavaMathBigInteger:[divisor getUnscaledValue]];
  integerQuot = [((IOSObjectArray *) nil_chk(quotAndRem)) objectAtIndex:0];
  if ([((JavaMathBigInteger *) nil_chk([quotAndRem objectAtIndex:1])) signum] != 0) {
    compRem = [((JavaMathBigInteger *) nil_chk([((JavaMathBigInteger *) nil_chk([quotAndRem objectAtIndex:1])) shiftLeftOneBit])) compareToWithId:[divisor getUnscaledValue]];
    integerQuot = [((JavaMathBigInteger *) nil_chk([((JavaMathBigInteger *) nil_chk(integerQuot)) multiplyWithJavaMathBigInteger:[JavaMathBigInteger TEN]])) addWithJavaMathBigInteger:[JavaMathBigInteger valueOfWithLongInt:[((JavaMathBigInteger *) nil_chk([quotAndRem objectAtIndex:0])) signum] * (5 + compRem)]];
    newScale++;
  }
  else {
    while (![((JavaMathBigInteger *) nil_chk(integerQuot)) testBitWithInt:0]) {
      quotAndRem = [integerQuot divideAndRemainderWithJavaMathBigInteger:[JavaMathBigDecimal_TEN_POW_ objectAtIndex:i]];
      if (([((JavaMathBigInteger *) nil_chk([((IOSObjectArray *) nil_chk(quotAndRem)) objectAtIndex:1])) signum] == 0) && (newScale - i >= diffScale)) {
        newScale -= i;
        if (i < lastPow) {
          i++;
        }
        integerQuot = [quotAndRem objectAtIndex:0];
      }
      else {
        if (i == 1) {
          break;
...
- (JavaMathBigDecimal *)divideToIntegralValueWithJavaMathBigDecimal:(JavaMathBigDecimal *)divisor {
  ...
  if (([divisor aproxPrecision] + newScale > [self aproxPrecision] + 1LL) || ([self isZero])) {
    ...
    while (![((JavaMathBigInteger *) nil_chk(integralValue)) testBitWithInt:0]) {
      quotAndRem = [integralValue divideAndRemainderWithJavaMathBigInteger:[JavaMathBigDecimal_TEN_POW_ objectAtIndex:i]];
      if (([((JavaMathBigInteger *) nil_chk([((IOSObjectArray *) nil_chk(quotAndRem)) objectAtIndex:1])) signum] == 0) && (tempScale - i >= newScale)) {
        tempScale -= i;
        if (i < lastPow) {
          i++;
        }
        integralValue = [quotAndRem objectAtIndex:0];
      }
      else {
        if (i == 1) {
          break;
...
- (JavaMathBigDecimal *)divideToIntegralValueWithJavaMathBigDecimal:(JavaMathBigDecimal *)divisor
  ...
  if (quotPrecision <= 0) {
    [quotAndRem replaceObjectAtIndex:0 withObject:[JavaMathBigInteger ZERO]];
  }
  else if (diffScale == 0) {
    [quotAndRem replaceObjectAtIndex:0 withObject:[((JavaMathBigInteger *) nil_chk([self getUnscaledValue])) divideWithJavaMathBigInteger:[divisor getUnscaledValue]]];
  }
  else if (diffScale > 0) {
    [quotAndRem replaceObjectAtIndex:0 withObject:[((JavaMathBigInteger *) nil_chk([self getUnscaledValue])) divideWithJavaMathBigInteger:[((JavaMathBigInteger *) nil_chk([divisor getUnscaledValue])) multiplyWithJavaMathBigInteger:[JavaMathMultiplication powerOf10WithLongInt:diffScale]]]];
    ...
    [quotAndRem replaceObjectAtIndex:0 withObject:[((JavaMathBigInteger *) nil_chk([quotAndRem objectAtIndex:0])) multiplyWithJavaMathBigInteger:[JavaMathMultiplication powerOf10WithLongInt:newScale]]];
  }
  else {
    ...
    quotAndRem = [((JavaMathBigInteger *) nil_chk([((JavaMathBigInteger *) nil_chk([self getUnscaledValue])) multiplyWithJavaMathBigInteger:[JavaMathMultiplication powerOf10WithLongInt:exp]])) divideAndRemainderWithJavaMathBigInteger:[divisor getUnscaledValue]];
    newScale += exp;
    exp = -newScale;
    if (([((JavaMathBigInteger *) nil_chk([((IOSObjectArray *) nil_chk(quotAndRem)) objectAtIndex:1])) signum] != 0) && (exp > 0)) {
      compRemDiv = [([[[JavaMathBigDecimal alloc] initWithJavaMathBigInteger:[quotAndRem objectAtIndex:1]] autorelease]) precision] + exp - [divisor precision];
      if (compRemDiv == 0) {
        [quotAndRem replaceObjectAtIndex:1 withObject:[((JavaMathBigInteger *) nil_chk([((JavaMathBigInteger *) nil_chk([quotAndRem objectAtIndex:1])) multiplyWithJavaMathBigInteger:[JavaMathMultiplication powerOf10WithLongInt:exp]])) divideWithJavaMathBigInteger:[divisor getUnscaledValue]]];
        compRemDiv = [JavaLangMath absWithInt:[((JavaMathBigInteger *) nil_chk([quotAndRem objectAtIndex:1])) signum]];
      }
      if (compRemDiv > 0) {
  ...
  if ([((JavaMathBigInteger *) nil_chk([((IOSObjectArray *) nil_chk(quotAndRem)) objectAtIndex:0])) signum] == 0) {
    return [JavaMathBigDecimal zeroScaledByWithLongInt:diffScale];
  }
  JavaMathBigInteger *strippedBI = [quotAndRem objectAtIndex:0];
  JavaMathBigDecimal *integralValue = [[[JavaMathBigDecimal alloc] initWithJavaMathBigInteger:[quotAndRem objectAtIndex:0]] autorelease];
  long long int resultPrecision = [integralValue precision];
  int i = 1;
  while (![((JavaMathBigInteger *) nil_chk(strippedBI)) testBitWithInt:0]) {
    quotAndRem = [strippedBI divideAndRemainderWithJavaMathBigInteger:[JavaMathBigDecimal_TEN_POW_ objectAtIndex:i]];
    if (([((JavaMathBigInteger *) nil_chk([((IOSObjectArray *) nil_chk(quotAndRem)) objectAtIndex:1])) signum] == 0) && ((resultPrecision - i >= mcPrecision) || (newScale - i >= diffScale))) {
      resultPrecision -= i;
      newScale -= i;
      if (i < lastPow) {
        i++;
      }
      strippedBI = [quotAndRem objectAtIndex:0];
    }
    else {
      if (i == 1) {
        break;
  ...
  integralValue->scale__ = [JavaMathBigDecimal toIntScaleWithLongInt:newScale];
...
- (JavaMathBigDecimal *)remainderWithJavaMathBigDecimal:(JavaMathBigDecimal *)divisor {
  return [((IOSObjectArray *) nil_chk([self divideAndRemainderWithJavaMathBigDecimal:divisor])) objectAtIndex:1];
}

- (JavaMathBigDecimal *)remainderWithJavaMathBigDecimal:(JavaMathBigDecimal *)divisor
                                withJavaMathMathContext:(JavaMathMathContext *)mc {
  return [((IOSObjectArray *) nil_chk([self divideAndRemainderWithJavaMathBigDecimal:divisor withJavaMathMathContext:mc])) objectAtIndex:1];
}
...
- (IOSObjectArray *)divideAndRemainderWithJavaMathBigDecimal:(JavaMathBigDecimal *)divisor {
  ...
  [quotAndRem replaceObjectAtIndex:0 withObject:[self divideToIntegralValueWithJavaMathBigDecimal:divisor]];
  [quotAndRem replaceObjectAtIndex:1 withObject:[self subtractWithJavaMathBigDecimal:[((JavaMathBigDecimal *) nil_chk([quotAndRem objectAtIndex:0])) multiplyWithJavaMathBigDecimal:divisor]]];
  return quotAndRem;
}
...
- (IOSObjectArray *)divideAndRemainderWithJavaMathBigDecimal:(JavaMathBigDecimal *)divisor
                                     withJavaMathMathContext:(JavaMathMathContext *)mc {
  IOSObjectArray *quotAndRem = [IOSObjectArray arrayWithLength:2 type:[IOSClass classWithClass:[JavaMathBigDecimal class]]];
  [quotAndRem replaceObjectAtIndex:0 withObject:[self divideToIntegralValueWithJavaMathBigDecimal:divisor withJavaMathMathContext:mc]];
  [quotAndRem replaceObjectAtIndex:1 withObject:[self subtractWithJavaMathBigDecimal:[((JavaMathBigDecimal *) nil_chk([quotAndRem objectAtIndex:0])) multiplyWithJavaMathBigDecimal:divisor]]];
  return quotAndRem;
}
...
- (JavaMathBigDecimal *)powWithInt:(int)n {
  ...
  return (([self isZero]) ? [JavaMathBigDecimal zeroScaledByWithLongInt:newScale] : [[[JavaMathBigDecimal alloc] initWithJavaMathBigInteger:[((JavaMathBigInteger *) nil_chk([self getUnscaledValue])) powWithInt:n] withInt:[JavaMathBigDecimal toIntScaleWithLongInt:newScale]] autorelease]);
}
...
- (int)signum {
  if (bitLength__ < 64) {
    return [JavaLangLong signumWithLongInt:self->smallValue_];
  }
...
- (int)precision {
  ...
  if (bitLength < 1024) {
    ...
    if ([((JavaMathBigInteger *) nil_chk([((JavaMathBigInteger *) nil_chk([self getUnscaledValue])) divideWithJavaMathBigInteger:[JavaMathMultiplication powerOf10WithLongInt:decimalDigits]])) signum] != 0) {
      decimalDigits++;
    }
  }
...
- (JavaMathBigDecimal *)setScaleWithInt:(int)newScale
  ...
  if (diffScale > 0) {
    if (diffScale < (int) [((IOSLongArray *) nil_chk(JavaMathBigDecimal_LONG_TEN_POW_)) count] && (self->bitLength__ + [((IOSIntArray *) nil_chk(JavaMathBigDecimal_LONG_TEN_POW_BIT_LENGTH_)) intAtIndex:(int) diffScale]) < 64) {
      return [JavaMathBigDecimal valueOfWithLongInt:self->smallValue_ * [JavaMathBigDecimal_LONG_TEN_POW_ longAtIndex:(int) diffScale] withInt:newScale];
    }
  ...
  if (self->bitLength__ < 64 && -diffScale < (int) [((IOSLongArray *) nil_chk(JavaMathBigDecimal_LONG_TEN_POW_)) count]) {
    return [JavaMathBigDecimal dividePrimitiveLongsWithLongInt:self->smallValue_ withLongInt:[JavaMathBigDecimal_LONG_TEN_POW_ longAtIndex:(int) -diffScale] withInt:newScale withJavaMathRoundingModeEnum:roundingMode];
  }
...
- (JavaMathBigDecimal *)movePointWithLongInt:(long long int)newScale {
  ...
  if (-newScale < (int) [((IOSLongArray *) nil_chk(JavaMathBigDecimal_LONG_TEN_POW_)) count] && bitLength__ + [((IOSIntArray *) nil_chk(JavaMathBigDecimal_LONG_TEN_POW_BIT_LENGTH_)) intAtIndex:(int) -newScale] < 64) {
    return [JavaMathBigDecimal valueOfWithLongInt:smallValue_ * [JavaMathBigDecimal_LONG_TEN_POW_ longAtIndex:(int) -newScale] withInt:0];
  }
...
- (NSString *)description {
  ...
  if (bitLength__ < 32) {
    JavaMathBigDecimal_set_toStringImage_(self, [JavaMathConversion toDecimalScaledStringWithLongInt:smallValue_ withInt:scale__]);
    return toStringImage_;
  }
  ...
  if ((scale__ > 0) && (exponent >= -6)) {
    if (exponent >= 0) {
      [result insertWithInt:end - scale__ withUnichar:'.'];
    }
    else {
    ...
    if (end - begin >= 1) {
      [result insertWithInt:begin withUnichar:'.'];
      end++;
    }
    [result insertWithInt:end withUnichar:'E'];
    if (exponent > 0) {
      [result insertWithInt:++end withUnichar:'+'];
    }
    [result insertWithInt:++end withNSString:[JavaLangLong toStringWithLongInt:exponent]];
  }
    ...
    if (rem != 0) {
      ...
      if (delta < 3) {
        for (int i = rem - delta; i > 0; i--) {
          [result insertWithInt:end++ withUnichar:'0'];
        }
      }
    }
    if (end - begin >= 1) {
...
- (JavaMathBigInteger *)toBigInteger {
  if ((scale__ == 0) || ([self isZero])) {
    ...
    return [((JavaMathBigInteger *) nil_chk([self getUnscaledValue])) multiplyWithJavaMathBigInteger:[JavaMathMultiplication powerOf10WithLongInt:-(long long int) scale__]];
  }
  else {
    return [((JavaMathBigInteger *) nil_chk([self getUnscaledValue])) divideWithJavaMathBigInteger:[JavaMathMultiplication powerOf10WithLongInt:scale__]];
  }
}
...
- (JavaMathBigInteger *)toBigIntegerExact {
  if ((scale__ == 0) || ([self isZero])) {
    ...
    integerAndFraction = [((JavaMathBigInteger *) nil_chk([self getUnscaledValue])) divideAndRemainderWithJavaMathBigInteger:[JavaMathMultiplication powerOf10WithLongInt:scale__]];
    if ([((JavaMathBigInteger *) nil_chk([((IOSObjectArray *) nil_chk(integerAndFraction)) objectAtIndex:1])) signum] != 0) {
      @throw [[[JavaLangArithmeticException alloc] initWithNSString:@"Rounding necessary"] autorelease];
    }
    return [integerAndFraction objectAtIndex:0];
  }
}

- (long long int)longValue {
  return ((scale__ <= -64) || (scale__ > [self aproxPrecision]) ? 0LL : [((JavaMathBigInteger *) nil_chk([self toBigInteger])) longValue]);
}
...
- (double)doubleValue {
  ...
  if (scale__ <= 0) {
    ...
    compRem = [((JavaMathBigInteger *) nil_chk([((JavaMathBigInteger *) nil_chk([((IOSObjectArray *) nil_chk(quotAndRem)) objectAtIndex:1])) shiftLeftOneBit])) compareToWithId:powerOfTen];
    mantisa = [((JavaMathBigInteger *) nil_chk([((JavaMathBigInteger *) nil_chk([quotAndRem objectAtIndex:0])) shiftLeftWithInt:2])) addWithJavaMathBigInteger:[JavaMathBigInteger valueOfWithLongInt:(compRem * (compRem + 3)) / 2 + 1]];
    exponent -= 2;
  }
...
- (void)inplaceRoundWithJavaMathMathContext:(JavaMathMathContext *)mc {
  ...
  if ([((JavaMathBigInteger *) nil_chk([((IOSObjectArray *) nil_chk(integerAndFraction)) objectAtIndex:1])) signum] != 0) {
    JavaMathBigInteger *fraction = [integerAndFraction objectAtIndex:1];
    ...
    compRem = [JavaMathBigDecimal roundingBehaviorWithInt:[((JavaMathBigInteger *) nil_chk([integerAndFraction objectAtIndex:0])) testBitWithInt:0] ? 1 : 0 withInt:[((JavaMathBigInteger *) nil_chk([integerAndFraction objectAtIndex:1])) signum] * (5 + compRem) withJavaMathRoundingModeEnum:[mc getRoundingMode]];
    if (compRem != 0) {
      [integerAndFraction replaceObjectAtIndex:0 withObject:[((JavaMathBigInteger *) nil_chk([integerAndFraction objectAtIndex:0])) addWithJavaMathBigInteger:[JavaMathBigInteger valueOfWithLongInt:compRem]]];
    }
    tempBD = [[[JavaMathBigDecimal alloc] initWithJavaMathBigInteger:[integerAndFraction objectAtIndex:0]] autorelease];
    if ([tempBD precision] > mcPrecision) {
      [integerAndFraction replaceObjectAtIndex:0 withObject:[((JavaMathBigInteger *) nil_chk([integerAndFraction objectAtIndex:0])) divideWithJavaMathBigInteger:[JavaMathBigInteger TEN]]];
      newScale--;
    }
  }
  scale__ = [JavaMathBigDecimal toIntScaleWithLongInt:newScale];
  precision__ = mcPrecision;
  [self setUnscaledValueWithJavaMathBigInteger:[integerAndFraction objectAtIndex:0]];
}
...
- (void)smallRoundWithJavaMathMathContext:(JavaMathMathContext *)mc
  ...
  if (fraction != 0) {
    ...
    if ([JavaLangMath log10WithDouble:[JavaLangMath absWithLongInt:integer]] >= [mc getPrecision]) {
      integer /= 10;
      newScale--;
    }
  }
...
- (JavaMathBigInteger *)getUnscaledValue {
  if (intVal_ == nil) {
    JavaMathBigDecimal_set_intVal_(self, [JavaMathBigInteger valueOfWithLongInt:smallValue_]);
  }
  return intVal_;
}
...
- (void)setUnscaledValueWithJavaMathBigInteger:(JavaMathBigInteger *)unscaledValue {
  ...
  if (self->bitLength__ < 64) {
    self->smallValue_ = [unscaledValue longValue];
  }
}
  ...
  if (self == [JavaMathBigDecimal class]) {
    ...
    JreOperatorRetainedAssign(&JavaMathBigDecimal_CH_ZEROS_, nil, [IOSCharArray arrayWithLength:100]);
    {
      ...
      for (; i < (int) [JavaMathBigDecimal_ZERO_SCALED_BY_ count]; i++) {
        [JavaMathBigDecimal_BI_SCALED_BY_ZERO_ replaceObjectAtIndex:i withObject:[[[JavaMathBigDecimal alloc] initWithInt:i withInt:0] autorelease]];
        [JavaMathBigDecimal_ZERO_SCALED_BY_ replaceObjectAtIndex:i withObject:[[[JavaMathBigDecimal alloc] initWithInt:0 withInt:i] autorelease]];
        (*[JavaMathBigDecimal_CH_ZEROS_ charRefAtIndex:i]) = '0';
      }
      for (; i < (int) [JavaMathBigDecimal_CH_ZEROS_ count]; i++) {
        (*[JavaMathBigDecimal_CH_ZEROS_ charRefAtIndex:i]) = '0';
      }
      for (int j = 0; j < (int) [JavaMathBigDecimal_LONG_FIVE_POW_BIT_LENGTH_ count]; j++) {
        (*[JavaMathBigDecimal_LONG_FIVE_POW_BIT_LENGTH_ intRefAtIndex:j]) = [JavaMathBigDecimal bitLengthWithLongInt:[JavaMathBigDecimal_LONG_FIVE_POW_ longAtIndex:j]];
      }
      for (int j = 0; j < (int) [JavaMathBigDecimal_LONG_TEN_POW_BIT_LENGTH_ count]; j++) {
        (*[JavaMathBigDecimal_LONG_TEN_POW_BIT_LENGTH_ intRefAtIndex:j]) = [JavaMathBigDecimal bitLengthWithLongInt:[JavaMathBigDecimal_LONG_TEN_POW_ longAtIndex:j]];
      }

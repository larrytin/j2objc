...
//  source: /Users/retechretech/dev/tools/lib/j2objc/jre_emul/apache_harmony/classlib/modules/math/src/main/java/java/math/MathContext.java
//
...
- (JavaMathRoundingModeEnum *)roundingMode {
  return [[roundingMode_ retain] autorelease];
}

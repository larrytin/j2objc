...
//  source: /Users/retechretech/dev/tools/lib/j2objc/jre_emul/apache_harmony/classlib/modules/luni/src/main/java/java/util/AbstractList.java
//
...
- (JavaUtilAbstractList *)this$1 {
  return [[this$1_ retain] autorelease];
}
...
- (JavaUtilAbstractList *)fullList {
  return [[fullList_ retain] autorelease];
}
...
- (JavaUtilAbstractList_SubAbstractList *)subList {
  return [[subList_ retain] autorelease];
}

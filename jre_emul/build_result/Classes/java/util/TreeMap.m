...
- (id<JavaUtilSet>)entrySet_ {
  return [[entrySet__ retain] autorelease];
}
...
- (JavaUtilTreeMap_Node *)root {
  return [[root_ retain] autorelease];
}
...
- (JavaUtilTreeMap_Node *)node {
  return [[node_ retain] autorelease];
}
...
- (id)initJavaUtilTreeMap_MapEntryWithJavaUtilTreeMap:(JavaUtilTreeMap *)outer$2
...
- (id)initWithJavaUtilTreeMap:(JavaUtilTreeMap *)outer$2
     withJavaUtilTreeMap_Node:(JavaUtilTreeMap_Node *)node
                      withInt:(int)offset {
  return [self initJavaUtilTreeMap_MapEntryWithJavaUtilTreeMap:outer$2 withJavaUtilTreeMap_Node:node withInt:offset];
}
...
- (JavaUtilTreeMap_Node *)prev {
  return [[prev_ retain] autorelease];
}
...
- (JavaUtilTreeMap_Node *)left {
  return [[left_ retain] autorelease];
}
...
- (JavaUtilTreeMap_Node *)right {
  return [[right_ retain] autorelease];
}
...
- (IOSObjectArray *)values {
  return [[values_ retain] autorelease];
}
...
- (JavaUtilTreeMap *)backingMap {
  return [[backingMap_ retain] autorelease];
}
...
- (JavaUtilTreeMap_Node *)lastNode {
  return [[lastNode_ retain] autorelease];
}
...
- (JavaUtilTreeMap_Node *)finalNode {
  return [[finalNode_ retain] autorelease];
}
...
- (id)startKey {
  return [[startKey_ retain] autorelease];
}
...
- (id)endKey {
  return [[endKey_ retain] autorelease];
}
...
- (JavaUtilTreeMap_Node *)firstKeyNode {
  return [[firstKeyNode_ retain] autorelease];
}
...
- (JavaUtilTreeMap_Node *)lastKeyNode {
  return [[lastKeyNode_ retain] autorelease];
}
...
- (JavaUtilTreeMap_SubMap *)subMap {
  return [[subMap_ retain] autorelease];
}
...
- (JavaUtilTreeMap *)map {
  return [[map_ retain] autorelease];
}
@synthesize map = map_;

...
+ (id<JavaLangComparable>)toComparableWithId:(id)obj {
  ...
  return (id<JavaLangComparable>) check_protocol_cast(obj, @protocol(JavaLangComparable));
}
...
- (id)clone {
  @try {
    JavaUtilTreeMap *clone = (JavaUtilTreeMap *) check_class_cast([super clone], [JavaUtilTreeMap class]);
...
- (BOOL)containsKeyWithId:(id)key {
  ...
  while (node != nil) {
    ...
    int result = [self cmpWithJavaLangComparable:object withId:keyK withId:IOSObjectArray_Get(nil_chk(keys), left_idx)];
    if (result < 0) {
      node = node->left_;
    }
    else if (result == 0) {
      ...
      if (left_idx != right_idx) {
        result = [self cmpWithJavaLangComparable:object withId:keyK withId:IOSObjectArray_Get(keys, right_idx)];
      }
      if (result > 0) {
        node = node->right_;
      }
        ...
        while (low <= high) {
          ...
          result = [self cmpWithJavaLangComparable:object withId:keyK withId:IOSObjectArray_Get(keys, mid)];
          if (result > 0) {
            low = mid + 1;
          }
          else if (result == 0) {
  ...
  if (value != nil) {
    while (node != nil) {
      ...
      for (int i = node->left_idx_; i <= to; i++) {
        if ([value isEqual:IOSObjectArray_Get(nil_chk(values), i)]) {
          return YES;
        }
      }
      node = node->next_;
    ...
    while (node != nil) {
      ...
      IOSObjectArray *values = node->values_;
      for (int i = node->left_idx_; i <= to; i++) {
        if (IOSObjectArray_Get(nil_chk(values), i) == nil) {
          return YES;
        }
      }
      node = node->next_;
...
- (id)firstKey {
  if (root_ != nil) {
    JavaUtilTreeMap_Node *node = [JavaUtilTreeMap minimumWithJavaUtilTreeMap_Node:root_];
    return IOSObjectArray_Get(nil_chk(((JavaUtilTreeMap_Node *) nil_chk(node))->keys_), node->left_idx_);
  }
...
- (id)getWithId:(id)key {
  ...
  while (node != nil) {
    ...
    if (result < 0) {
      ...
      return IOSObjectArray_Get(nil_chk(node->values_), left_idx);
    }
    else {
      int right_idx = node->right_idx_;
      if (left_idx != right_idx) {
      ...
      if (result > 0) {
        ...
        return IOSObjectArray_Get(nil_chk(node->values_), right_idx);
      }
      else {
        int low = left_idx + 1, mid = 0, high = right_idx - 1;
        while (low <= high) {
          ...
          if (result > 0) {
            ...
            return IOSObjectArray_Get(nil_chk(node->values_), mid);
          }
          else {
            high = mid - 1;
          }
...
- (id)lastKey {
  if (root_ != nil) {
    ...
    return IOSObjectArray_Get(nil_chk(((JavaUtilTreeMap_Node *) nil_chk(node))->keys_), node->right_idx_);
  }
  @throw [[[JavaUtilNoSuchElementException alloc] init] autorelease];
}
...
- (id)putWithId:(id)key
  ...
  while (node != nil) {
    ...
    IOSObjectArray *keys = ((JavaUtilTreeMap_Node *) nil_chk(node))->keys_;
    int left_idx = node->left_idx_;
    result = [self cmpWithJavaLangComparable:object withId:keyK withId:IOSObjectArray_Get(nil_chk(keys), left_idx)];
    if (result < 0) {
      node = node->left_;
    }
    else if (result == 0) {
      id res = IOSObjectArray_Get(nil_chk(node->values_), left_idx);
      IOSObjectArray_Set(node->values_, left_idx, value);
      return res;
    }
    else {
      int right_idx = node->right_idx_;
      ...
      if (result > 0) {
        ...
        id res = IOSObjectArray_Get(nil_chk(node->values_), right_idx);
        IOSObjectArray_Set(node->values_, right_idx, value);
        return res;
      }
      else {
        int low = left_idx + 1, mid = 0, high = right_idx - 1;
        while (low <= high) {
          ...
          if (result > 0) {
            ...
            id res = IOSObjectArray_Get(nil_chk(node->values_), mid);
            IOSObjectArray_Set(node->values_, mid, value);
            return res;
          }
          else {
            high = mid - 1;
  ...
  if (node == nil) {
    ...
    if (node->size_ < JavaUtilTreeMap_Node_NODE_SIZE) {
      ...
      if (left_idx == 0 || ((right_idx != JavaUtilTreeMap_Node_NODE_SIZE - 1) && (right_idx - result <= result - left_idx))) {
        ...
        IOSObjectArray_Set(nil_chk(node->keys_), result, key);
        IOSObjectArray_Set(nil_chk(node->values_), result, value);
      }
      else {
        ...
        IOSObjectArray_Set(nil_chk(node->keys_), result - 1, key);
        IOSObjectArray_Set(nil_chk(node->values_), result - 1, value);
      }
      node->size_++;
    }
    else {
      ...
      id movedValue;
      if (removeFromStart) {
        movedKey = IOSObjectArray_Get(nil_chk(node->keys_), 0);
        movedValue = IOSObjectArray_Get(nil_chk(node->values_), 0);
        ...
        IOSObjectArray_Set(node->keys_, resMunus1, key);
        IOSObjectArray_Set(node->values_, resMunus1, value);
      }
      else {
        movedKey = IOSObjectArray_Get(nil_chk(node->keys_), JavaUtilTreeMap_Node_NODE_SIZE - 1);
        movedValue = IOSObjectArray_Get(nil_chk(node->values_), JavaUtilTreeMap_Node_NODE_SIZE - 1);
        ...
        IOSObjectArray_Set(node->keys_, result, key);
        IOSObjectArray_Set(node->values_, result, value);
      }
      if (attachHere == nil) {
        if (removeFromStart) {
...
- (void)appendFromLeftWithJavaUtilTreeMap_Node:(JavaUtilTreeMap_Node *)node
  ...
  node->size_++;
  IOSObjectArray_Set(nil_chk(node->keys_), node->left_idx_, keyObj);
  IOSObjectArray_Set(nil_chk(node->values_), node->left_idx_, value);
}
...
- (void)appendFromRightWithJavaUtilTreeMap_Node:(JavaUtilTreeMap_Node *)node
  ...
  node->size_++;
  IOSObjectArray_Set(nil_chk(node->keys_), node->right_idx_, keyObj);
  IOSObjectArray_Set(nil_chk(node->values_), node->right_idx_, value);
}
...
- (JavaUtilTreeMap_Node *)createNodeWithId:(id)keyObj
  ...
  IOSObjectArray_Set(nil_chk(node->keys_), 0, keyObj);
  IOSObjectArray_Set(nil_chk(node->values_), 0, value);
  node->left_idx_ = 0;
  node->right_idx_ = 0;
  node->size_ = 1;
  return node;
...
- (id)removeWithId:(id)key {
  ...
  while (node != nil) {
    ...
    if (result < 0) {
      ...
      id value = IOSObjectArray_Get(nil_chk(node->values_), left_idx);
      ...
      if (result > 0) {
        ...
        id value = IOSObjectArray_Get(nil_chk(node->values_), right_idx);
        ...
        while (low <= high) {
          ...
          if (result > 0) {
            ...
            id value = IOSObjectArray_Get(nil_chk(node->values_), mid);
...
- (void)removeLeftmostWithJavaUtilTreeMap_Node:(JavaUtilTreeMap_Node *)node {
  ...
  if (node->size_ == 1) {
    ...
    IOSObjectArray_Set(nil_chk(node->keys_), index, nil);
    IOSObjectArray_Set(nil_chk(node->values_), index, nil);
    node->left_idx_++;
    node->size_--;
    JavaUtilTreeMap_Node *prev = node->prev_;
    if (prev != nil && prev->size_ == 1) {
      node->size_++;
      node->left_idx_--;
      IOSObjectArray_Set(node->keys_, node->left_idx_, IOSObjectArray_Get(prev->keys_, prev->left_idx_));
      IOSObjectArray_Set(node->values_, node->left_idx_, IOSObjectArray_Get(prev->values_, prev->left_idx_));
...
- (void)removeRightmostWithJavaUtilTreeMap_Node:(JavaUtilTreeMap_Node *)node {
  ...
  if (node->size_ == 1) {
    ...
    if (next != nil && next->size_ == 1) {
      node->size_++;
      node->right_idx_++;
      IOSObjectArray_Set(node->keys_, node->right_idx_, IOSObjectArray_Get(next->keys_, next->left_idx_));
      IOSObjectArray_Set(node->values_, node->right_idx_, IOSObjectArray_Get(next->values_, next->left_idx_));
...
- (void)removeMiddleElementWithJavaUtilTreeMap_Node:(JavaUtilTreeMap_Node *)node
  ...
  if (((JavaUtilTreeMap_Node *) nil_chk(node))->prev_ != nil && (JavaUtilTreeMap_Node_NODE_SIZE - 1 - node->prev_->right_idx_) > node->size_) {
    ...
    if (moveFromRight <= moveFromLeft) {
      ...
      JavaUtilTreeMap_Node *next = node->next_;
      if (next != nil && next->size_ == 1) {
        IOSObjectArray_Set(nil_chk(node->keys_), node->right_idx_, IOSObjectArray_Get(next->keys_, next->left_idx_));
        IOSObjectArray_Set(nil_chk(node->values_), node->right_idx_, IOSObjectArray_Get(next->values_, next->left_idx_));
        [self deleteNodeWithJavaUtilTreeMap_Node:next];
      }
      else {
        IOSObjectArray_Set(nil_chk(node->keys_), node->right_idx_, nil);
        IOSObjectArray_Set(nil_chk(node->values_), node->right_idx_, nil);
        node->right_idx_--;
        node->size_--;
      }
    }
      ...
      JavaUtilTreeMap_Node *prev = node->prev_;
      if (prev != nil && prev->size_ == 1) {
        IOSObjectArray_Set(nil_chk(node->keys_), left_idx, IOSObjectArray_Get(prev->keys_, prev->left_idx_));
        IOSObjectArray_Set(nil_chk(node->values_), left_idx, IOSObjectArray_Get(prev->values_, prev->left_idx_));
        [self deleteNodeWithJavaUtilTreeMap_Node:prev];
      }
      else {
        IOSObjectArray_Set(nil_chk(node->keys_), left_idx, nil);
        IOSObjectArray_Set(nil_chk(node->values_), left_idx, nil);
        node->left_idx_++;
        node->size_--;
      }
    }
...
- (id)initJavaUtilTreeMap_MapEntryWithJavaUtilTreeMap:(JavaUtilTreeMap *)outer$
  ...
  if (self = [super init]) {
    ...
    self->offset_ = offset;
    JavaUtilTreeMap_MapEntry_set_key_(self, IOSObjectArray_Get(nil_chk(((JavaUtilTreeMap_Node *) nil_chk(node))->keys_), offset));
    JreMemDebugAdd(self);
  }
  return self;
}
...
- (id)getValue {
  if (IOSObjectArray_Get(nil_chk(((JavaUtilTreeMap_Node *) nil_chk(node_))->keys_), offset_) == key_) {
    return IOSObjectArray_Get(nil_chk(node_->values_), offset_);
  }
...
- (id)setValueWithId:(id)object {
  if (IOSObjectArray_Get(nil_chk(((JavaUtilTreeMap_Node *) nil_chk(node_))->keys_), offset_) == key_) {
    id res = IOSObjectArray_Get(nil_chk(node_->values_), offset_);
    IOSObjectArray_Set(node_->values_, offset_, object);
    return res;
  }
  if ([this$0_ containsKeyWithId:key_]) {
...
- (id)init {
  if (self = [super init]) {
    ...
    right_idx_ = -1;
    size_ = 0;
    JavaUtilTreeMap_Node_set_keys_(self, (IOSObjectArray *) check_class_cast([IOSObjectArray arrayWithLength:JavaUtilTreeMap_Node_NODE_SIZE type:[IOSClass classWithClass:[NSObject class]]], [IOSObjectArray class]));
    JavaUtilTreeMap_Node_set_values_(self, (IOSObjectArray *) check_class_cast([IOSObjectArray arrayWithLength:JavaUtilTreeMap_Node_NODE_SIZE type:[IOSClass classWithClass:[NSObject class]]], [IOSObjectArray class]));
    JreMemDebugAdd(self);
  }
  return self;
}
...
- (JavaUtilTreeMap_Node *)cloneWithJavaUtilTreeMap_Node:(JavaUtilTreeMap_Node *)parent {
  JavaUtilTreeMap_Node *clone = (JavaUtilTreeMap_Node *) check_class_cast([super clone], [JavaUtilTreeMap_Node class]);
  JavaUtilTreeMap_Node_set_keys_(nil_chk(clone), (IOSObjectArray *) check_class_cast([IOSObjectArray arrayWithLength:JavaUtilTreeMap_Node_NODE_SIZE type:[IOSClass classWithClass:[NSObject class]]], [IOSObjectArray class]));
  JavaUtilTreeMap_Node_set_values_(clone, (IOSObjectArray *) check_class_cast([IOSObjectArray arrayWithLength:JavaUtilTreeMap_Node_NODE_SIZE type:[IOSClass classWithClass:[NSObject class]]], [IOSObjectArray class]));
...
- (id)next {
  [self makeNext];
  return IOSObjectArray_Get(nil_chk(((JavaUtilTreeMap_Node *) nil_chk(lastNode_))->keys_), lastNode_->right_idx_ - lastOffset_);
}
...
- (id)next {
  [self makeNext];
  return IOSObjectArray_Get(nil_chk(((JavaUtilTreeMap_Node *) nil_chk(lastNode_))->values_), lastNode_->right_idx_ - lastOffset_);
}
...
- (void)setFirstKey {
  ...
  while (node != nil) {
    IOSObjectArray *keys = ((JavaUtilTreeMap_Node *) nil_chk(node))->keys_;
    int left_idx = node->left_idx_;
    int result = [backingMap_ cmpWithJavaLangComparable:object withId:key withId:IOSObjectArray_Get(nil_chk(keys), left_idx)];
    if (result < 0) {
      foundNode = node;
      foundIndex = left_idx;
      node = node->left_;
      ...
      int right_idx = node->right_idx_;
      if (left_idx != right_idx) {
        result = [backingMap_ cmpWithJavaLangComparable:object withId:key withId:IOSObjectArray_Get(keys, right_idx)];
      }
      if (result > 0) {
        node = node->right_;
      }
        ...
        while (low <= high) {
          mid = (int) (((unsigned int) (low + high)) >> 1);
          result = [backingMap_ cmpWithJavaLangComparable:object withId:key withId:IOSObjectArray_Get(keys, mid)];
          if (result > 0) {
            low = mid + 1;
          }
          else if (result == 0) {
  ...
  break_TOP_LOOP: ;
  if (foundNode != nil && ![self checkUpperBoundWithId:IOSObjectArray_Get(nil_chk(foundNode->keys_), foundIndex)]) {
    foundNode = nil;
  }
...
- (id)firstKey {
  if (((JavaUtilTreeMap *) nil_chk(backingMap_))->size__ > 0) {
    if (!hasStart_) {
      ...
      if (node != nil && [self checkUpperBoundWithId:IOSObjectArray_Get(nil_chk(node->keys_), node->left_idx_)]) {
        return IOSObjectArray_Get(node->keys_, node->left_idx_);
      }
    }
    else {
      [self setFirstKey];
      if (firstKeyNode_ != nil) {
        return IOSObjectArray_Get(nil_chk(firstKeyNode_->keys_), firstKeyIndex_);
      }
    }
  }
  @throw [[[JavaUtilNoSuchElementException alloc] init] autorelease];
...
- (void)setLastKey {
  ...
  break_TOP_LOOP: ;
  if (foundNode != nil && ![self checkLowerBoundWithId:IOSObjectArray_Get(nil_chk(foundNode->keys_), foundIndex)]) {
    foundNode = nil;
  }
...
- (id)lastKey {
  if (((JavaUtilTreeMap *) nil_chk(backingMap_))->size__ > 0) {
    if (!hasEnd_) {
      ...
      if (node != nil && [self checkLowerBoundWithId:IOSObjectArray_Get(nil_chk(node->keys_), node->right_idx_)]) {
        return IOSObjectArray_Get(node->keys_, node->right_idx_);
      }
    }
    else {
      [self setLastKey];
      if (lastKeyNode_ != nil) {
        return IOSObjectArray_Get(nil_chk(lastKeyNode_->keys_), lastKeyIndex_);
      }
    }
  }
  @throw [[[JavaUtilNoSuchElementException alloc] init] autorelease];

...
+ (void)copy__WithJavaUtilList:(id<JavaUtilList>)destination
  ...
  if ([((id<JavaUtilList>) nil_chk(destination)) size] < [((id<JavaUtilList>) nil_chk(source)) size]) {
    @throw [[[JavaLangArrayIndexOutOfBoundsException alloc] initWithNSString:[NSString stringWithFormat:@"Source size %d does not fit into destination", [source size]]] autorelease];
  }
...
+ (void)reverseWithJavaUtilList:(id<JavaUtilList>)list {
  ...
  id<JavaUtilListIterator> front = (id<JavaUtilListIterator>) [list listIterator];
  id<JavaUtilListIterator> back = (id<JavaUtilListIterator>) [list listIteratorWithInt:size];
...
+ (id<JavaUtilComparator>)reverseOrderWithJavaUtilComparator:(id<JavaUtilComparator>)c {
  ...
  if ([(id) c isKindOfClass:[JavaUtilCollections_ReverseComparatorWithComparator class]]) {
    return ((JavaUtilCollections_ReverseComparatorWithComparator *) nil_chk(c))->comparator_;
  }
...
+ (void)shuffleWithJavaUtilList:(id<JavaUtilList>)list
  ...
  if ([(id) list conformsToProtocol: @protocol(JavaUtilRandomAccess)]) {
    ...
    for (int i = (int) [((IOSObjectArray *) nil_chk(array)) count] - 1; i > 0; i--) {
      ...
      [array replaceObjectAtIndex:i withObject:[array objectAtIndex:index]];
      [array replaceObjectAtIndex:index withObject:temp];
    }
    int i = 0;
    id<JavaUtilListIterator> it = [objectList listIterator];
    while ([((id<JavaUtilListIterator>) nil_chk(it)) hasNext]) {
      [it next];
      [it setWithId:[array objectAtIndex:i++]];
    }
  }
}
...
+ (void)sortWithJavaUtilList:(id<JavaUtilList>)list {
  ...
  while ([((id<JavaUtilListIterator>) nil_chk(it)) hasNext]) {
    [it next];
    [it setWithId:(id<JavaLangComparable>) [((IOSObjectArray *) nil_chk(array)) objectAtIndex:i++]];
  }
}

+ (void)sortWithJavaUtilList:(id<JavaUtilList>)list
      withJavaUtilComparator:(id<JavaUtilComparator>)comparator {
  IOSObjectArray *array = [list toArrayWithNSObjectArray:(IOSObjectArray *) [IOSObjectArray arrayWithLength:[((id<JavaUtilList>) nil_chk(list)) size] type:[IOSClass classWithClass:[NSObject class]]]];
  [JavaUtilArrays sortWithNSObjectArray:array withJavaUtilComparator:comparator];
  int i = 0;
  id<JavaUtilListIterator> it = [list listIterator];
  while ([((id<JavaUtilListIterator>) nil_chk(it)) hasNext]) {
    [it next];
    [it setWithId:[((IOSObjectArray *) nil_chk(array)) objectAtIndex:i++]];
  }
}
...
+ (BOOL)addAllWithJavaUtilCollection:(id<JavaUtilCollection>)c
  ...
  for (int i = 0; i < (int) [((IOSObjectArray *) nil_chk(a)) count]; i++) {
    modified |= [((id<JavaUtilCollection>) nil_chk(c)) addWithId:[a objectAtIndex:i]];
  }
  return modified;
}
...
+ (id)checkTypeWithId:(id)obj
  ...
  if (obj != nil && ![((IOSClass *) nil_chk(type)) isInstance:obj]) {
    @throw [[[JavaLangClassCastException alloc] initWithNSString:[NSString stringWithFormat:@"Attempt to insert %@element into collection with an element type %@", [obj getClass], type]] autorelease];
  }
  return obj;
}
...
- (id<JavaUtilIterator>)iterator {
  return [[[JavaUtilCollections_EmptySet_$1 alloc] init] autorelease];
}
...
- (id)initWithJavaUtilComparator:(id<JavaUtilComparator>)comparator {
  if ((self = [super init])) {
    JavaUtilCollections_ReverseComparatorWithComparator_set_comparator_(self, comparator);
    JreMemDebugAdd(self);
  }
  return self;
}
...
- (BOOL)isEqual:(id)o {
  return [o isKindOfClass:[JavaUtilCollections_ReverseComparatorWithComparator class]] && [((id<JavaUtilComparator>) nil_chk(((JavaUtilCollections_ReverseComparatorWithComparator *) nil_chk(o))->comparator_)) isEqual:comparator_];
}
...
- (void)dealloc {
  JreMemDebugRemove(self);
  JavaUtilCollections_ReverseComparatorWithComparator_set_comparator_(self, nil);
  [super dealloc];
}

- (void)copyAllFieldsTo:(JavaUtilCollections_ReverseComparatorWithComparator *)other {
  [super copyAllFieldsTo:other];
  JavaUtilCollections_ReverseComparatorWithComparator_set_comparator_(other, comparator_);
}
...
- (id)initWithJavaUtilCollection:(id<JavaUtilCollection>)collection {
  if ((self = [super init])) {
    ...
    JavaUtilCollections_SynchronizedCollection_set_mutex_(self, [[[NSObject alloc] init] autorelease]);
    JreMemDebugAdd(self);
  }
  return self;
}
...
- (int)indexOfWithId:(id)object {
  ...
  if (nil != object) for (int i = 0; i < size; i++) {
    if ([object isEqual:[array objectAtIndex:i]]) {
      return i;
    }
  }
  else {
    for (int i = 0; i < size; i++) {
      if (nil == [array objectAtIndex:i]) {
        return i;
      }
    }
  }
...
- (id)initWithJavaUtilMap:(id<JavaUtilMap>)map {
  if ((self = [super init])) {
    ...
    JavaUtilCollections_SynchronizedMap_set_mutex_(self, [[[NSObject alloc] init] autorelease]);
    JreMemDebugAdd(self);
  }
  return self;
}
...
- (IOSObjectArray *)toArray {
  ...
  for (int i = length; --i >= 0; ) {
    [result replaceObjectAtIndex:i withObject:[((id<JavaUtilIterator>) nil_chk(it)) next]];
  }
  return result;
}
...
- (BOOL)addAllWithJavaUtilCollection:(id<JavaUtilCollection>)c1 {
  IOSObjectArray *array = [((id<JavaUtilCollection>) nil_chk(c1)) toArray];
  {
    ...
    for (int i__ = 0; i__ < n__; i__++) {
      id o = [a__ objectAtIndex:i__];
      [JavaUtilCollections checkTypeWithId:o withIOSClass:type_];
    }
  }
  return [((id<JavaUtilCollection>) nil_chk(c_)) addAllWithJavaUtilCollection:(id<JavaUtilList>) [JavaUtilArrays asListWithNSObjectArray:array]];
}
...
withJavaUtilCollection:(id<JavaUtilCollection>)c1 {
  ...
  return [((id<JavaUtilList>) nil_chk(l_)) addAllWithInt:index withJavaUtilCollection:(id<JavaUtilList>) [JavaUtilArrays asListWithNSObjectArray:array]];
}
...
- (void)putAllWithJavaUtilMap:(id<JavaUtilMap>)map {
  ...
  for (int i = 0; i < size; i++) {
    ...
    [entries replaceObjectAtIndex:i withObject:e];
  }
  for (int i = 0; i < size; i++) {
    [((id<JavaUtilMap>) nil_chk(m_)) putWithId:[((id<JavaUtilMap_Entry>) nil_chk([entries objectAtIndex:i])) getKey] withId:[((id<JavaUtilMap_Entry>) nil_chk([entries objectAtIndex:i])) getValue]];
  }
}
...
- (id)initWithJavaUtilCollection:(id<JavaUtilCollection>)capture$0 {
  if ((self = [super init])) {
    JavaUtilCollections_$1_set_val$c_(self, capture$0);
    JavaUtilCollections_$1_set_it_(self, [((id<JavaUtilCollection>) nil_chk(val$c_)) iterator]);
    JreMemDebugAdd(self);
  }
  return self;
}
...
- (void)dealloc {
  JreMemDebugRemove(self);
  JavaUtilCollections_$1_set_val$c_(self, nil);
  JavaUtilCollections_$1_set_it_(self, nil);
  [super dealloc];
}

- (void)copyAllFieldsTo:(JavaUtilCollections_$1 *)other {
  [super copyAllFieldsTo:other];
  JavaUtilCollections_$1_set_it_(other, it_);
}

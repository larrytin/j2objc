...
- (id<JavaUtilMap_Entry>)next {
  ...
  hasNext__ = NO;
  return [[[JavaUtilCollections_SingletonMap_$1_$1_$1 alloc] initWithId:this$0_.this$0.k withId:this$0_.this$0.v] autorelease];
}
...
- (id)initWithJavaUtilCollection:(id<JavaUtilCollection>)collection {
  if ((self = [super init])) {
    ...
    JreOperatorRetainedAssign(&mutex_, [[[NSObject alloc] init] autorelease]);
    JreMemDebugAdd(self);
  }
  return self;
}
...
- (id)initWithJavaUtilCollections_UnmodifiableCollection:(JavaUtilCollections_UnmodifiableCollection *)outer$ {
  if ((self = [super init])) {
    JreOperatorRetainedAssign(&iterator_, ((id<JavaUtilIterator>) [((id<JavaUtilCollection>) NIL_CHK(outer$.c)) iterator]));
    JreMemDebugAdd(self);
  }
  return self;
}
...
- (id)initWithJavaUtilCollections_UnmodifiableList:(JavaUtilCollections_UnmodifiableList *)outer$
  ...
  if ((self = [super init])) {
    ...
    JreOperatorRetainedAssign(&iterator_, ((id<JavaUtilListIterator>) [((id<JavaUtilList>) NIL_CHK(outer$.list)) listIteratorWithInt:val$location_]));
    JreMemDebugAdd(self);
  }
  return self;
}
...
- (id)initWithJavaUtilCollection:(id<JavaUtilCollection>)capture$0 {
  if ((self = [super init])) {
    JreOperatorRetainedAssign(&val$c_, capture$0);

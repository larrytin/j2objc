...
//  source: /Users/retechretech/dev/tools/lib/j2objc/jre_emul/apache_harmony/classlib/modules/luni/src/main/java/java/util/Collections.java
//
...
@synthesize n = n_;
- (id)element {
  return [[element_ retain] autorelease];
}
...
- (id<JavaUtilComparator>)comparator {
  return [[comparator_ retain] autorelease];
}
...
@synthesize c = c_;
- (id)mutex {
  return [[mutex_ retain] autorelease];
}
...
@synthesize this$0 = this$0_;
- (id<JavaUtilIterator>)iterator {
  return [[iterator_ retain] autorelease];
}
...
- (id<JavaUtilMap_Entry>)mapEntry {
  return [[mapEntry_ retain] autorelease];
}
...
@synthesize e = e_;
- (IOSClass *)valueType {
  return [[valueType_ retain] autorelease];
}
...
@synthesize m = m_;
- (IOSClass *)keyType {
  return [[keyType_ retain] autorelease];
}
...
- (id<JavaUtilCollection>)val$c {
  return [[val$c_ retain] autorelease];
}

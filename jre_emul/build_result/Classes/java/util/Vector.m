...
- (id)initWithJavaUtilCollection:(id<JavaUtilCollection>)collection {
  if ((self = [self initJavaUtilVectorWithInt:[((id<JavaUtilCollection>) nil_chk(collection)) size] withInt:0])) {
    ...
    while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
      [((IOSObjectArray *) nil_chk(elementData_)) replaceObjectAtIndex:elementCount_++ withObject:[it next]];
    }
    JreMemDebugAdd(self);
  }
  return self;
  ...
  @synchronized(self) {
    {
      ...
      [elementData_ replaceObjectAtIndex:elementCount_++ withObject:object];
      modCount_++;
      return YES;
    }
  }
  ...
  @synchronized(self) {
    {
      if (0 <= location && location <= elementCount_) {
        ...
        id<JavaUtilIterator> it = [collection iterator];
        while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
          [elementData_ replaceObjectAtIndex:location++ withObject:[it next]];
        }
        elementCount_ += size;
        modCount_++;
        return YES;
  ...
  @synchronized(self) {
    {
      ...
      if ([object conformsToProtocol: @protocol(JavaUtilList)]) {
        ...
        while ([((id<JavaUtilIterator>) nil_chk(it)) hasNext]) {
          id e1 = [((IOSObjectArray *) nil_chk(elementData_)) objectAtIndex:index++], e2 = [it next];
  ...
  @synchronized(self) {
    {
      ...
      for (int i = 0; i < elementCount_; i++) {
        result = (31 * result) + ([((IOSObjectArray *) nil_chk(elementData_)) objectAtIndex:i] == nil ? 0 : [nil_chk([elementData_ objectAtIndex:i]) hash]);
      }
      return result;
    }
  }
  ...
  @synchronized(self) {
    {
      if (0 <= location && location <= elementCount_) {
        ...
        [elementData_ replaceObjectAtIndex:location withObject:object];
        elementCount_++;
        modCount_++;
      }
      else {
  ...
  @synchronized(self) {
    {
      if (location < elementCount_) {
        ...
        [elementData_ replaceObjectAtIndex:elementCount_ withObject:nil];
        modCount_++;
        return result;
      }
      @throw [[[JavaLangArrayIndexOutOfBoundsException alloc] initWithInt:location] autorelease];
  ...
  @synchronized(self) {
    {
      ...
      if (elementCount_ < (int) [((IOSObjectArray *) nil_chk(contents)) count]) {
        [contents replaceObjectAtIndex:elementCount_ withObject:nil];
      }
      return contents;
    }
  }
  ...
  @synchronized(self) {
    {
      ...
      for (int i = 0; i < length; i++) {
        if ([((IOSObjectArray *) nil_chk(elementData_)) objectAtIndex:i] == self) {
          ...
          [buffer appendWithId:[elementData_ objectAtIndex:i]];
        }
      ...
      if ([((IOSObjectArray *) nil_chk(elementData_)) objectAtIndex:length] == self) {
        ...
        [buffer appendWithId:[elementData_ objectAtIndex:length]];
      }
      [buffer appendWithUnichar:']'];
...
- (id)nextElement {
  @synchronized (this$0_) {
    if (pos_ < this$0_->elementCount_) {
      return (id) [((IOSObjectArray *) nil_chk(this$0_->elementData_)) objectAtIndex:pos_++];
    }
  }
  @throw [[[JavaUtilNoSuchElementException alloc] init] autorelease];
}

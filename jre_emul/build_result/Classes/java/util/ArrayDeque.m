...
//  source: /Users/retechretech/dev/tools/lib/j2objc/jre_emul/android/libcore/luni/src/main/java/java/util/ArrayDeque.java
//
...
- (void)doubleCapacity {
  NSAssert(head_ == tail_, @"/Users/retechretech/dev/tools/lib/j2objc/jre_emul/android/libcore/luni/src/main/java/java/util/ArrayDeque.java:120 condition failed: assert head == tail;");
  int p = head_;
...
- (void)checkInvariants {
  NSAssert([((IOSObjectArray *) NIL_CHK(elements_)) objectAtIndex:tail_] == nil, @"/Users/retechretech/dev/tools/lib/j2objc/jre_emul/android/libcore/luni/src/main/java/java/util/ArrayDeque.java:483 condition failed: assert elements[tail] == null;");
  NSAssert(head_ == tail_ ? [((IOSObjectArray *) NIL_CHK(elements_)) objectAtIndex:head_] == nil : ([((IOSObjectArray *) NIL_CHK(elements_)) objectAtIndex:head_] != nil && [((IOSObjectArray *) NIL_CHK(elements_)) objectAtIndex:(tail_ - 1) & ((int) [((IOSObjectArray *) NIL_CHK(elements_)) count] - 1)] != nil), @"/Users/retechretech/dev/tools/lib/j2objc/jre_emul/android/libcore/luni/src/main/java/java/util/ArrayDeque.java:484 condition failed: assert head == tail ? elements[head] == null :\n            (elements[head] != null &&\n             elements[(tail - 1) & (elements.length - 1)] != null);");
  NSAssert([((IOSObjectArray *) NIL_CHK(elements_)) objectAtIndex:(head_ - 1) & ((int) [((IOSObjectArray *) NIL_CHK(elements_)) count] - 1)] == nil, @"/Users/retechretech/dev/tools/lib/j2objc/jre_emul/android/libcore/luni/src/main/java/java/util/ArrayDeque.java:487 condition failed: assert elements[(head - 1) & (elements.length - 1)] == null;");
}

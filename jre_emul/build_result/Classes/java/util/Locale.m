...
//  source: /Users/retechretech/dev/tools/lib/j2objc/jre_emul/apache_harmony/classlib/modules/luni/src/main/java/java/util/Locale.java
//
...
- (NSString *)countryCode {
  return [[countryCode_ retain] autorelease];
}
...
- (NSString *)languageCode {
  return [[languageCode_ retain] autorelease];
}
...
- (NSString *)variantCode {
  return [[variantCode_ retain] autorelease];
}
...
+ (void)setDefaultLocaleWithJavaUtilLocale:(JavaUtilLocale *)defaultLocale {

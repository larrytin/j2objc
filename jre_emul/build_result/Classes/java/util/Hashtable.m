  ...
  @synchronized(self) {
    {
      @try {
        ...
        for (int i = (int) [elementData_ count]; --i >= 0; ) {
          if ((entry = [elementData_ objectAtIndex:i]) != nil) {
            [hashtable->elementData_ replaceObjectAtIndex:i withObject:(JavaUtilHashtable_Entry *) [((JavaUtilHashtable_Entry *) nil_chk(entry)) clone]];
          }
        }
        return hashtable;
      }
  ...
  @synchronized(self) {
    {
      ...
      for (int i = (int) [((IOSObjectArray *) nil_chk(elementData_)) count]; --i >= 0; ) {
        JavaUtilHashtable_Entry *entry = [elementData_ objectAtIndex:i];
        while (entry != nil) {
  ...
  @synchronized(self) {
    {
      ...
      if ([object conformsToProtocol: @protocol(JavaUtilMap)]) {
        ...
        {
          id<JavaUtilIterator> iter__ = [((id<JavaUtilSet>) nil_chk([map entrySet])) iterator];
          while ([((id<JavaUtilIterator>) nil_chk(iter__)) hasNext]) {
            id<JavaUtilMap_Entry> e = [iter__ next];
  ...
  @synchronized(self) {
    {
      ...
      JavaUtilHashtable_Entry *entry = [elementData_ objectAtIndex:index];
      while (entry != nil) {
  ...
  @synchronized(self) {
    {
      if (key != nil && value != nil) {
        ...
        if (entry == nil) {
          ...
          JavaUtilHashtable_Entry_set_next_(nil_chk(entry), [elementData_ objectAtIndex:index]);
          [elementData_ replaceObjectAtIndex:index withObject:entry];
          return nil;
        }
...
- (void)rehash {
  ...
  for (int i = lastSlot_ + 1; --i >= firstSlot_; ) {
    ...
    while (entry != nil) {
      ...
      JavaUtilHashtable_Entry_set_next_(entry, [((IOSObjectArray *) nil_chk(newData)) objectAtIndex:index]);
      [newData replaceObjectAtIndex:index withObject:entry];
      entry = next;
    }
  }
  firstSlot_ = newFirst;
  ...
  @synchronized(self) {
    {
      ...
      if (entry != nil) {
        modCount_++;
        if (last == nil) {
          [elementData_ replaceObjectAtIndex:index withObject:entry->next_];
        }
        else {
  ...
  @synchronized(self) {
    {
      ...
      for (int i = lastSlot_; i >= firstSlot_; i--) {
        JavaUtilHashtable_Entry *entry = [((IOSObjectArray *) nil_chk(elementData_)) objectAtIndex:i];
        while (entry != nil) {
...
- (id)clone {
  ...
  if (next_ != nil) {
    JavaUtilHashtable_Entry_set_next_(nil_chk(entry), (JavaUtilHashtable_Entry *) [next_ clone]);
  }
  return entry;
}
...
- (BOOL)hasNext {
  ...
  while (position_ >= this$0_->firstSlot_) {
    if ([((IOSObjectArray *) nil_chk(this$0_->elementData_)) objectAtIndex:position_] == nil) {
      position_--;
    }
    else {
      return YES;
...
- (id)next {
  if (expectedModCount_ == this$0_->modCount_) {
    ...
    if (lastEntry_ == nil) {
      while (position_ >= this$0_->firstSlot_ && (JavaUtilHashtable_HashIterator_set_lastEntry_(self, [((IOSObjectArray *) nil_chk(this$0_->elementData_)) objectAtIndex:position_])) == nil) {
        position_--;
      }
      if (lastEntry_ != nil) {
  ...
  if (expectedModCount_ == this$0_->modCount_) {
    if (canRemove_) {
      ...
      @synchronized (this$0_) {
        BOOL removed = NO;
        JavaUtilHashtable_Entry *entry = [((IOSObjectArray *) nil_chk(this$0_->elementData_)) objectAtIndex:lastPosition_];
        if (entry == lastEntry_) {
          [this$0_->elementData_ replaceObjectAtIndex:lastPosition_ withObject:((JavaUtilHashtable_Entry *) nil_chk(entry))->next_];
          removed = YES;
        }
        else {
...
- (BOOL)hasMoreElements {
  if (isEnumeration_) {
    ...
    while (start_ > this$1_->firstSlot_) {
      if ([((IOSObjectArray *) nil_chk(this$1_->elementData_)) objectAtIndex:--start_] != nil) {
        JavaUtilHashtable_HashEnumIterator_set_entry_(self, [this$1_->elementData_ objectAtIndex:start_]);
        return YES;
      }
    }
    return NO;

...
- (id)initWithNSString:(NSString *)string
  ...
  return JreMemDebugAdd([self initJavaUtilStringTokenizerWithNSString:string withNSString:delimiters withBoolean:NO]);
}
...
- (id)initWithNSString:(NSString *)string
          withNSString:(NSString *)delimiters
           withBoolean:(BOOL)returnDelimiters {
  return [self initJavaUtilStringTokenizerWithNSString:string withNSString:delimiters withBoolean:returnDelimiters];
}

...
//  source: /Users/retechretech/dev/tools/lib/j2objc/jre_emul/Classes/java/util/logging/LogRecord.java
//
...
- (JavaUtilLoggingLevel *)level {
  return [[level_ retain] autorelease];
}
...
- (NSString *)loggerName {
  return [[loggerName_ retain] autorelease];
}
...
- (NSString *)msg {
  return [[msg_ retain] autorelease];
}
...
- (JavaLangThrowable *)thrown {
  return [[thrown_ retain] autorelease];
}

...
//  source: /Users/retechretech/dev/tools/lib/j2objc/jre_emul/Classes/java/util/logging/LogManager.java
//
...
- (JavaUtilHashMap *)loggerList {
  return [[loggerList_ retain] autorelease];
}
...
- (JavaUtilLoggingLogger *)rootLogger {
  return [[rootLogger_ retain] autorelease];
}

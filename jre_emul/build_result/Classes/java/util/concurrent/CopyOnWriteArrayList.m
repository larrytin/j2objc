...
- (id)initWithJavaUtilCollection:(id<JavaUtilCollection>)collection {
  return JreMemDebugAdd([self initJavaUtilConcurrentCopyOnWriteArrayListWithNSObjectArray:(IOSObjectArray *) [((id<JavaUtilCollection>) nil_chk(collection)) toArray]]);
}
...
- (id)clone {
  @try {
    JavaUtilConcurrentCopyOnWriteArrayList *result = (JavaUtilConcurrentCopyOnWriteArrayList *) [super clone];
...
- (id)getWithInt:(int)index {
  return (id) [((IOSObjectArray *) nil_chk(elements_)) objectAtIndex:index];
}
...
- (IOSObjectArray *)toArrayWithNSObjectArray:(IOSObjectArray *)contents {
  ...
  if ((int) [((IOSObjectArray *) nil_chk(snapshot)) count] > (int) [((IOSObjectArray *) nil_chk(contents)) count]) {
    return (IOSObjectArray *) [JavaUtilArrays copyOfWithNSObjectArray:snapshot withInt:(int) [snapshot count] withIOSClass:[contents getClass]];
  }
  ...
  if ((int) [snapshot count] < (int) [contents count]) {
    [contents replaceObjectAtIndex:(int) [snapshot count] withObject:nil];
  }
  return contents;
}
  ...
  @synchronized(self) {
    {
      ...
      [newElements replaceObjectAtIndex:(int) [elements_ count] withObject:e];
  ...
  @synchronized(self) {
    {
      ...
      [newElements replaceObjectAtIndex:index withObject:e];
      ...
      int addedCount = 0;
      {
        ...
        for (int i__ = 0; i__ < n__; i__++) {
          ...
          if ([JavaUtilConcurrentCopyOnWriteArrayList indexOfWithId:o withNSObjectArray:newElements withInt:0 withInt:(int) [elements_ count] + addedCount] == -1) {
            [newElements replaceObjectAtIndex:(int) [elements_ count] + addedCount++ withObject:o];
          }
        }
      }
...
- (id)removeWithInt:(int)index {
  @synchronized(self) {
    {
      id removed = (id) [((IOSObjectArray *) nil_chk(elements_)) objectAtIndex:index];
...
- (BOOL)removeAllWithJavaUtilCollection:(id<JavaUtilCollection>)collection {
  @synchronized(self) {
    {
      return [self removeOrRetainWithJavaUtilCollection:collection withBOOL:NO withInt:0 withInt:(int) [((IOSObjectArray *) nil_chk(elements_)) count]] != 0;
    }
  }
}
...
- (BOOL)retainAllWithJavaUtilCollection:(id<JavaUtilCollection>)collection {
  @synchronized(self) {
    {
      return [self removeOrRetainWithJavaUtilCollection:collection withBOOL:YES withInt:0 withInt:(int) [((IOSObjectArray *) nil_chk(elements_)) count]] != 0;
    }
  }
}
...
- (int)removeOrRetainWithJavaUtilCollection:(id<JavaUtilCollection>)collection
  ...
  for (int i = from; i < to; i++) {
    if ([((id<JavaUtilCollection>) nil_chk(collection)) containsWithId:[((IOSObjectArray *) nil_chk(elements_)) objectAtIndex:i]] == retain_) {
      continue;
    }
    ...
    for (int j = i + 1; j < to; j++) {
      if ([collection containsWithId:[elements_ objectAtIndex:j]] == retain_) {
        [newElements replaceObjectAtIndex:newSize++ withObject:[elements_ objectAtIndex:j]];
      }
    }
  ...
  @synchronized(self) {
    {
      ...
      id result = (id) [((IOSObjectArray *) nil_chk(newElements)) objectAtIndex:index];
      [newElements replaceObjectAtIndex:index withObject:e];
      JavaUtilConcurrentCopyOnWriteArrayList_set_elements_(self, newElements);
      return result;
    }
...
+ (int)lastIndexOfWithId:(id)o
  ...
  if (o == nil) {
    for (int i = to - 1; i >= from; i--) {
      if ([((IOSObjectArray *) nil_chk(data)) objectAtIndex:i] == nil) {
        return i;
      }
    }
  }
    ...
    for (int i = to - 1; i >= from; i--) {
      if ([o isEqual:[((IOSObjectArray *) nil_chk(data)) objectAtIndex:i]]) {
        return i;
      }
    }
  }
...
- (id)getWithInt:(int)index {
  ...
  return (id) [((IOSObjectArray *) nil_chk(snapshot)) objectAtIndex:index + slice->from_];
}
...
- (BOOL)removeAllWithJavaUtilCollection:(id<JavaUtilCollection>)collection {
  @synchronized (this$0_) {
    [((JavaUtilConcurrentCopyOnWriteArrayList_Slice *) nil_chk(slice_)) checkConcurrentModificationWithNSObjectArray:this$0_->elements_];
    int removed = [this$0_ removeOrRetainWithJavaUtilCollection:collection withBOOL:NO withInt:slice_->from_ withInt:slice_->to_];
...
- (BOOL)retainAllWithJavaUtilCollection:(id<JavaUtilCollection>)collection {
  @synchronized (this$0_) {
    [((JavaUtilConcurrentCopyOnWriteArrayList_Slice *) nil_chk(slice_)) checkConcurrentModificationWithNSObjectArray:this$0_->elements_];
    int removed = [this$0_ removeOrRetainWithJavaUtilCollection:collection withBOOL:YES withInt:slice_->from_ withInt:slice_->to_];
    JavaUtilConcurrentCopyOnWriteArrayList_CowSubList_set_slice_(self, [[[JavaUtilConcurrentCopyOnWriteArrayList_Slice alloc] initWithNSObjectArray:this$0_->elements_ withInt:slice_->from_ withInt:slice_->to_ - removed] autorelease]);
    return removed != 0;
  }
}
...
- (id)next {
  if (index_ < to_) {
    return (id) [((IOSObjectArray *) nil_chk(snapshot_)) objectAtIndex:index_++];
  }
  else {

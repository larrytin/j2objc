...
//  source: /Users/retechretech/dev/tools/lib/j2objc/jre_emul/android/libcore/luni/src/main/java/java/util/TimeZone.java
//
...
@synthesize ID = ID_;
- (id)nativeTimeZone {
  return [[nativeTimeZone_ retain] autorelease];
}
...
+ (void)setDefaultTimeZoneWithJavaUtilTimeZone:(JavaUtilTimeZone *)defaultTimeZone {
...
- (NSString *)getDisplayNameWithBOOL:(BOOL)daylightTime
  ...
  if (useDaylight && [self isKindOfClass:[JavaUtilSimpleTimeZone class]]) {
...
+ (JavaUtilTimeZone *)getCustomTimeZoneWithNSString:(NSString *)id_ {
  ...
  NSString *cleanId = [NSString stringWithFormat:@"GMT%C%02d:%02d" , sign, hour, minute, nil];

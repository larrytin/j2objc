...
//  source: /Users/retechretech/dev/tools/lib/j2objc/jre_emul/apache_harmony/classlib/modules/luni/src/main/java/java/util/Hashtable.java
//
//  Created by retechretech on 13-3-15.
//

@class IOSObjectArray;
@class JavaUtilHashtable_$4;
@class JavaUtilHashtable_$6;
@class JavaUtilHashtable_$7;
...
@interface JavaUtilHashtable_$4_$1 : NSObject < JavaUtilMapEntry_Type > {
 @public
  JavaUtilHashtable_$4 *this$0_;
}

@property (nonatomic, retain) JavaUtilHashtable_$4 *this$0;
...
@interface JavaUtilHashtable_$6_$1 : NSObject < JavaUtilMapEntry_Type > {
 @public
  JavaUtilHashtable_$6 *this$0_;
}

@property (nonatomic, retain) JavaUtilHashtable_$6 *this$0;
...
@interface JavaUtilHashtable_$7_$1 : NSObject < JavaUtilMapEntry_Type > {
 @public
  JavaUtilHashtable_$7 *this$0_;
}

@property (nonatomic, retain) JavaUtilHashtable_$7 *this$0;

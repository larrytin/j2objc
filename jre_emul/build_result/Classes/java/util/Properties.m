...
- (void)listToAppendableWithJavaLangAppendable:(id<JavaLangAppendable>)outArg {
  @try {
    ...
    while ([((id<JavaUtilEnumeration>) nil_chk(keys)) hasMoreElements]) {
      NSString *key = (NSString *) [keys nextElement];
  ...
  @synchronized(self) {
    {
      ...
      while (YES) {
        ...
        if (mode == JavaUtilProperties_UNICODE) {
          ...
          (*[buf charRefAtIndex:offset++]) = (unichar) unicode;
          if (nextChar != 0x000a) {
            continue;
          }
        }
        ...
        (*[buf charRefAtIndex:offset++]) = nextChar;
      }
  ...
  @synchronized(self) {
    {
      ...
      JavaLangStringBuilder *sb = [[[JavaLangStringBuilder alloc] initWithInt:200] autorelease];
      {
        ...
        while ([((id<JavaUtilIterator>) nil_chk(iter__)) hasNext]) {
          ...
          [sb appendWithUnichar:'='];
          [self dumpStringWithJavaLangStringBuilder:sb withNSString:(NSString *) [entry getValue] withBOOL:NO];
          [sb appendWithNSString:[JavaLangSystem lineSeparator]];
  ...
  @synchronized(self) {
    {
      ...
      }
      {
        ...
        while ([((id<JavaUtilIterator>) nil_chk(iter__)) hasNext]) {
          ...
          NSString *entryValue = (NSString *) [entry getValue];

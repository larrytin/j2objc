...
J2OBJC_FIELD_SETTER(JavaUtilCollections_CopiesList, element_, id)
...
J2OBJC_FIELD_SETTER(JavaUtilCollections_ReverseComparatorWithComparator, comparator_, id<JavaUtilComparator>)
...
J2OBJC_FIELD_SETTER(JavaUtilCollections_SingletonSet_$1, this$0_, JavaUtilCollections_SingletonSet *)
...
J2OBJC_FIELD_SETTER(JavaUtilCollections_SingletonMap_$1, this$0_, JavaUtilCollections_SingletonMap *)
...
J2OBJC_FIELD_SETTER(JavaUtilCollections_SingletonMap_$1_$1, this$0_, JavaUtilCollections_SingletonMap_$1 *)
...
J2OBJC_FIELD_SETTER(JavaUtilCollections_SynchronizedMap, m_, id<JavaUtilMap>)
...
J2OBJC_FIELD_SETTER(JavaUtilCollections_SynchronizedSortedMap, sm_, id<JavaUtilSortedMap>)
...
J2OBJC_FIELD_SETTER(JavaUtilCollections_SynchronizedSortedSet, ss_, id<JavaUtilSortedSet>)
...
J2OBJC_FIELD_SETTER(JavaUtilCollections_UnmodifiableMap, m_, id<JavaUtilMap>)
...
J2OBJC_FIELD_SETTER(JavaUtilCollections_UnmodifiableSortedMap, sm_, id<JavaUtilSortedMap>)
...
J2OBJC_FIELD_SETTER(JavaUtilCollections_UnmodifiableSortedSet, ss_, id<JavaUtilSortedSet>)
...
J2OBJC_FIELD_SETTER(JavaUtilCollections_CheckedListIterator, i_, id<JavaUtilListIterator>)
J2OBJC_FIELD_SETTER(JavaUtilCollections_CheckedListIterator, type_, IOSClass *)
...
J2OBJC_FIELD_SETTER(JavaUtilCollections_CheckedSortedSet, ss_, id<JavaUtilSortedSet>)
...
J2OBJC_FIELD_SETTER(JavaUtilCollections_SetFromMap, m_, id<JavaUtilMap>)
J2OBJC_FIELD_SETTER(JavaUtilCollections_SetFromMap, backingSet_, id<JavaUtilSet>)
...
J2OBJC_FIELD_SETTER(JavaUtilCollections_AsLIFOQueue, q_, id<JavaUtilDeque>)
...
J2OBJC_FIELD_SETTER(JavaUtilCollections_$1, it_, id<JavaUtilIterator>)
J2OBJC_FIELD_SETTER(JavaUtilCollections_$1, val$c_, id<JavaUtilCollection>)

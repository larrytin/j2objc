...
//  source: /Users/retechretech/dev/tools/lib/j2objc/jre_emul/apache_harmony/classlib/modules/luni/src/main/java/java/util/MiniEnumSet.java
//
...
- (IOSObjectArray *)enums {
  return [[enums_ retain] autorelease];
}
...
- (JavaLangEnum *)last {
  return [[last_ retain] autorelease];
}
...
- (id)initWithJavaUtilMiniEnumSet:(JavaUtilMiniEnumSet *)outer$0 {
  if ((self = [super init])) {
    JreOperatorRetainedAssign(&this$0_, outer$0);
    currentBits_ = this$0_.bits;
    mask_ = currentBits_ & -currentBits_;
    JreMemDebugAdd(self);
  }
  return self;

...
//  source: /Users/retechretech/dev/tools/lib/j2objc/jre_emul/apache_harmony/classlib/modules/luni/src/main/java/java/util/Arrays.java
//
    ...
    if (elem == nil) {
      ...
      if ([NIL_CHK(elemClass) isArray]) {
        ...
        if ([NIL_CHK(elemElemClass) isPrimitive]) {
          ...
          NSAssert(([elem isKindOfClass:[IOSObjectArray class]] ? [[(IOSObjectArray *) elem elementType] isEqual:[IOSClass classWithClass:[NSObject class]]] : NO), @"/Users/retechretech/dev/tools/lib/j2objc/jre_emul/apache_harmony/classlib/modules/luni/src/main/java/java/util/Arrays.java:3434 condition failed: assert elem instanceof Object[];");

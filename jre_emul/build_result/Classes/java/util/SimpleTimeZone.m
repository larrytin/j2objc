...
- (int)getOffsetWithLongInt:(long long int)time {
  ...
  IOSIntArray *fields = [JavaUtilGrego timeToFieldsWithLongInt:time + rawOffset_ withIntArray:nil];
  return [self getOffsetWithInt:JavaUtilGregorianCalendar_AD withInt:[((IOSIntArray *) nil_chk(fields)) intAtIndex:0] withInt:[fields intAtIndex:1] withInt:[fields intAtIndex:2] withInt:[fields intAtIndex:3] withInt:[fields intAtIndex:5]];
}

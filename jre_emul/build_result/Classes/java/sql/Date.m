...
- (id)initWithLong:(long long int)theDate {
  return JreMemDebugAdd([super initWithLong:[JavaSqlDate normalizeTimeWithLong:theDate]]);
}
...
- (void)setTimeWithLong:(long long int)theTime {
  [super setTimeWithLong:[JavaSqlDate normalizeTimeWithLong:theTime]];
}
...
+ (long long int)normalizeTimeWithLong:(long long int)theTime {
  return theTime;
}

...
- (id)init {
  if (self = [super init]) {
    [self createWithJavaLangThreadGroup:nil withJavaLangRunnable:nil withNSString:JavaLangThread_THREAD_ withLong:0 withBoolean:YES];
    JreMemDebugAdd(self);
  }
  return self;
}
...
- (id)initWithJavaLangRunnable:(id<JavaLangRunnable>)runnable {
  if (self = [super init]) {
    [self createWithJavaLangThreadGroup:nil withJavaLangRunnable:runnable withNSString:JavaLangThread_THREAD_ withLong:0 withBoolean:YES];
    JreMemDebugAdd(self);
  }
  return self;
}
...
- (id)initWithJavaLangRunnable:(id<JavaLangRunnable>)runnable
  ...
  if (self = [super init]) {
    [self createWithJavaLangThreadGroup:nil withJavaLangRunnable:runnable withNSString:threadName withLong:0 withBoolean:YES];
    JreMemDebugAdd(self);
  }
  return self;
}
...
- (id)initWithNSString:(NSString *)threadName {
  if (self = [super init]) {
    [self createWithJavaLangThreadGroup:nil withJavaLangRunnable:nil withNSString:threadName withLong:0 withBoolean:YES];
    JreMemDebugAdd(self);
  }
  return self;
}
...
- (id)initWithJavaLangThreadGroup:(JavaLangThreadGroup *)group
  ...
  if (self = [super init]) {
    [self createWithJavaLangThreadGroup:group withJavaLangRunnable:runnable withNSString:JavaLangThread_THREAD_ withLong:0 withBoolean:YES];
    JreMemDebugAdd(self);
  }
  return self;
}
...
- (id)initWithJavaLangThreadGroup:(JavaLangThreadGroup *)group
  ...
  if (self = [super init]) {
    [self createWithJavaLangThreadGroup:group withJavaLangRunnable:runnable withNSString:threadName withLong:stack withBoolean:YES];
    JreMemDebugAdd(self);
  }
  return self;
}
...
- (id)initWithJavaLangThreadGroup:(JavaLangThreadGroup *)group
             withJavaLangRunnable:(id<JavaLangRunnable>)runnable
                     withNSString:(NSString *)threadName {
  if (self = [super init]) {
    [self createWithJavaLangThreadGroup:group withJavaLangRunnable:runnable withNSString:threadName withLong:0 withBoolean:YES];
    JreMemDebugAdd(self);
  }
  return self;
}
...
- (id)initWithJavaLangThreadGroup:(JavaLangThreadGroup *)group
                     withNSString:(NSString *)threadName {
  if (self = [super init]) {
    [self createWithJavaLangThreadGroup:group withJavaLangRunnable:nil withNSString:threadName withLong:0 withBoolean:YES];
    JreMemDebugAdd(self);
  }
  return self;
}
...
- (id)initWithJavaLangThreadGroup:(JavaLangThreadGroup *)group
  ...
  if (self = [super init]) {
    [self createWithJavaLangThreadGroup:group withJavaLangRunnable:nil withNSString:threadName withLong:0 withBoolean:createThread];
    JreMemDebugAdd(self);
  }
  return self;
}
...
- (IOSObjectArray *)getStackTrace {
  ...
  for (int i = 0; i < (int) [exceptionTrace count]; i++) {
    NSString *methodName = [((JavaLangStackTraceElement *) nil_chk(IOSObjectArray_Get(exceptionTrace, i))) getMethodName];
...
- (void)join {
  [self joinWithLong:JavaLangLong_MAX_VALUE];
}
...
- (void)joinWithLong:(long long int)millis {
  [self joinWithLong:millis withInt:0];
}

+ (IOSObjectArray *)__exceptions_joinWithLong_ {
  return [IOSObjectArray arrayWithObjects:(id[]) { [JavaLangInterruptedException getClass] } count:1 type:[IOSClass getClass]];
}
...
- (void)joinWithLong:(long long int)millis
  ...
  [self join0WithLong:millisToWait withInt:JavaLangThread_POLL_INTERVAL];
}

+ (IOSObjectArray *)__exceptions_joinWithLong_withInt_ {
  return [IOSObjectArray arrayWithObjects:(id[]) { [JavaLangInterruptedException getClass] } count:1 type:[IOSClass getClass]];
}

- (void)join0WithLong:(long long int)millis
...
+ (IOSObjectArray *)__exceptions_join0WithLong_withInt_ {
  return [IOSObjectArray arrayWithObjects:(id[]) { [JavaLangInterruptedException getClass] } count:1 type:[IOSClass getClass]];
}
...
+ (void)sleepWithLong:(long long int)millis {
  [JavaLangThread sleepWithLong:millis withInt:0];
}

+ (IOSObjectArray *)__exceptions_sleepWithLong_ {
  return [IOSObjectArray arrayWithObjects:(id[]) { [JavaLangInterruptedException getClass] } count:1 type:[IOSClass getClass]];
}
...
+ (IOSObjectArray *)__exceptions_sleepWithLong_withInt_ {
  return [IOSObjectArray arrayWithObjects:(id[]) { [JavaLangInterruptedException getClass] } count:1 type:[IOSClass getClass]];
}
...
+ (JavaLangThread_StateEnum *)valueOfWithNSString:(NSString *)name {
  for (int i = 0; i < [JavaLangThread_StateEnum_values count]; i++) {
    JavaLangThread_StateEnum *e = JavaLangThread_StateEnum_values->buffer_[i];

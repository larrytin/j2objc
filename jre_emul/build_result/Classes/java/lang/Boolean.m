...
+ (void)initialize {
  if (self == [JavaLangBoolean class]) {
    JreOperatorRetainedAssign(&JavaLangBoolean_TYPE_, nil, (IOSClass *) [[[IOSBooleanArray arrayWithLength:0] getClass] getComponentType]);
    JreOperatorRetainedAssign(&JavaLangBoolean_TRUE__, nil, [[[JavaLangBoolean alloc] initWithBOOL:YES] autorelease]);
    JreOperatorRetainedAssign(&JavaLangBoolean_FALSE__, nil, [[[JavaLangBoolean alloc] initWithBOOL:NO] autorelease]);
  }
}

...
+ (double)copySignWithDouble:(double)magnitude
  ...
  return [JavaLangDouble longBitsToDoubleWithLongInt:magnitudeBits];
}
...
+ (double)nextUpWithDouble:(double)d {
  ...
  if (d == 0) {
    ...
    return [JavaLangDouble longBitsToDoubleWithLongInt:[JavaLangDouble doubleToLongBitsWithDouble:d] + 1];
  }
  else {
    return [JavaLangDouble longBitsToDoubleWithLongInt:[JavaLangDouble doubleToLongBitsWithDouble:d] - 1];
  }

...
//  source: /Users/retechretech/dev/tools/lib/j2objc/jre_emul/apache_harmony/classlib/modules/luni/src/main/java/java/lang/StringBuilder.java
//
...
- (id)initJavaLangStringBuilderWithJavaLangCharSequence:(id<JavaLangCharSequence>)seq {
  if ((self = [super init])) {
    ...
    [[((id<JavaLangCharSequence>) NIL_CHK(seq)) description] getChars:0 sourceEnd:count_ destination:value_ destinationBegin:0];
    JreMemDebugAdd(self);
  }
  return self;
}

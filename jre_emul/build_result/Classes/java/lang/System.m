...
+ (void)setSystemLogger:(JavaUtilLoggingLogger *)systemLogger {
  JreOperatorRetainedAssign(&JavaLangSystem_systemLogger_, systemLogger);
}
...
+ (void)logWithJavaUtilLoggingLevel:(JavaUtilLoggingLevel *)level
  ...
  if (JavaLangSystem_systemLogger_ == nil) {
    JreOperatorRetainedAssign(&JavaLangSystem_systemLogger_, [JavaUtilLoggingLogger getLoggerWithNSString:@"java.lang.System"]);
  }

...
- (IOSObjectArray *)childrenThreads {
  return [[childrenThreads_ retain] autorelease];
}
...
- (IOSObjectArray *)childrenGroups {
  return [[childrenGroups_ retain] autorelease];
}
...
- (id)childrenGroupsLock {
  return [[childrenGroupsLock_ retain] autorelease];
}
...
- (id)childrenThreadsLock {
  return [[childrenThreadsLock_ retain] autorelease];
}
...
- (JavaLangThreadGroup *)this$0 {
  return [[this$0_ retain] autorelease];
}
- (void)setThis$0:(JavaLangThreadGroup *)this$0 {
...
- (void)copyAllPropertiesTo:(id)copy {
  [super copyAllPropertiesTo:copy];
  JavaLangThreadGroup_ChildrenGroupsLock *typedCopy = (JavaLangThreadGroup_ChildrenGroupsLock *) copy;
...
- (void)copyAllPropertiesTo:(id)copy {
  [super copyAllPropertiesTo:copy];
  JavaLangThreadGroup_ChildrenThreadsLock *typedCopy = (JavaLangThreadGroup_ChildrenThreadsLock *) copy;
  typedCopy.this$0 = this$0_;
}

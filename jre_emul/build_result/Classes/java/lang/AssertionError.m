...
- (id)initJavaLangAssertionErrorWithId:(id)detailMessage {
  return JreMemDebugAdd([super initWithNSString:[NSString valueOf:detailMessage] withJavaLangThrowable:([detailMessage isKindOfClass:[JavaLangThrowable class]] ? (JavaLangThrowable *) check_class_cast(detailMessage, [JavaLangThrowable class]) : nil)]);
}
...
- (id)initWithLong:(long long int)detailMessage {
  return JreMemDebugAdd([self initJavaLangAssertionErrorWithId:[JavaLangLong toStringWithLong:detailMessage]]);
}

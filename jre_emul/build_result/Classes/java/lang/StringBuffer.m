...
- (id)initWithNSString:(NSString *)string {
  return JreMemDebugAdd([self initJavaLangStringBufferWithJavaLangCharSequence:(id<JavaLangCharSequence>) check_protocol_cast(string, @protocol(JavaLangCharSequence))]);
}
...
- (JavaLangStringBuffer *)insertWithInt:(int)index
  ...
  @synchronized(self) {
    {
      return [self insertWithInt:index withNSString:[JavaLangLong toStringWithLong:l]];
    }
  }
}

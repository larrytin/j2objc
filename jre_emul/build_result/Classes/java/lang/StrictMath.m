...
+ (void)setRandom_:(JavaUtilRandom *)random_ {
  JreOperatorRetainedAssign(&JavaLangStrictMath_random__, nil, random_);
}
...
+ (double)random {
  if (JavaLangStrictMath_random__ == nil) JreOperatorRetainedAssign(&JavaLangStrictMath_random__, nil, [[[JavaUtilRandom alloc] init] autorelease]);

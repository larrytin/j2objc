...
@class JavaUtilIdentityHashMap_KeySet;
@class JavaUtilIdentityHashMap_ValuesCollection;
...
@interface JavaUtilIdentityHashMap_KeySet_$1 : NSObject < JavaUtilMapEntry_Type > {
 @public
  JavaUtilIdentityHashMap_KeySet *this$0_;
}

@property (nonatomic, retain) JavaUtilIdentityHashMap_KeySet *this$0;
...
@interface JavaUtilIdentityHashMap_ValuesCollection_$1 : NSObject < JavaUtilMapEntry_Type > {
 @public
  JavaUtilIdentityHashMap_ValuesCollection *this$0_;
}

@property (nonatomic, retain) JavaUtilIdentityHashMap_ValuesCollection *this$0;

...
- (void)printWithJunitFrameworkTestResult:(JunitFrameworkTestResult *)result
  ...
  @synchronized(self) {
    {
      [self printHeaderWithLongInt:runTime];
...
- (void)printHeaderWithLongInt:(long long int)runTime {
  [((JavaIoPrintStream *) nil_chk([self getWriter])) println];
  [((JavaIoPrintStream *) nil_chk([self getWriter])) printlnWithNSString:[NSString stringWithFormat:@"Time: %@", [self elapsedTimeAsStringWithLongInt:runTime]]];
}

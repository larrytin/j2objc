...
//  source: /Users/retechretech/dev/tools/lib/j2objc/junit/build_result/java/junit/framework/JUnit4TestAdapterCache.java
//
...
- (id<JunitFrameworkTest>)createTestWithOrgJunitRunnerDescription:(OrgJunitRunnerDescription *)description_ {
  if ([((OrgJunitRunnerDescription *) nil_chk(description_)) isTest]) return [[[JunitFrameworkJUnit4TestCaseFacade alloc] initWithOrgJunitRunnerDescription:description_] autorelease];
    ...
    {
      id<JavaUtilIterator> iter__ = [((JavaUtilArrayList *) nil_chk([description_ getChildren])) iterator];
      while ([((id<JavaUtilIterator>) nil_chk(iter__)) hasNext]) {
        OrgJunitRunnerDescription *child = [iter__ next];
        [suite addTestWithJunitFrameworkTest:[self asTestWithOrgJunitRunnerDescription:child]];
      }
    }
    return suite;
  }

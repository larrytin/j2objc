...
- (NSString *)fName {
  return [[fName_ retain] autorelease];
}
...
- (JavaUtilVector *)fTests {
  return [[fTests_ retain] autorelease];
}
...
- (NSString *)val$message {
  return [[val$message_ retain] autorelease];
}
...
- (id)initWithNSString:(NSString *)arg$0
          withNSString:(NSString *)outer$1 {
  if ((self = [super initWithNSString:arg$0])) {
    JreOperatorRetainedAssign(&val$message_, outer$1);
  }
  return self;
}

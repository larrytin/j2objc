...
@class JavaUtilEnumMap_EnumMapKeySet;
@class JavaUtilEnumMap_EnumMapValueCollection;
...
@interface JavaUtilEnumMap_EnumMapKeySet_$1 : NSObject < JavaUtilMapEntry_Type > {
 @public
  JavaUtilEnumMap_EnumMapKeySet *this$0_;
}

@property (nonatomic, retain) JavaUtilEnumMap_EnumMapKeySet *this$0;
...
@interface JavaUtilEnumMap_EnumMapValueCollection_$1 : NSObject < JavaUtilMapEntry_Type > {
 @public
  JavaUtilEnumMap_EnumMapValueCollection *this$0_;
}

@property (nonatomic, retain) JavaUtilEnumMap_EnumMapValueCollection *this$0;
...
@interface JavaUtilEnumMap_EnumMapEntrySet_$1 : NSObject < JavaUtilMapEntry_Type > {
 @public
  JavaUtilEnumMap_EnumMapEntrySet *this$0_;
}

@property (nonatomic, retain) JavaUtilEnumMap_EnumMapEntrySet *this$0;

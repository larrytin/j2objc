...
//  source: /Users/retechretech/dev/tools/lib/j2objc/junit/build_result/java/org/junit/internal/runners/rules/RuleFieldValidator.java
//
...
- (id)initWithIOSClass:(IOSClass *)annotation
              withBOOL:(BOOL)onlyStaticFields
